...
// For now use `type Periph struct{}` and generate methods with pointer
// receiver. This works better with current egc, which to implement methods that
// can be used with interfaces, generates two C functions for method with
// pointer receiver and three C functions for method with value receiver.
