...
func (p *SDIO_Periph) ENCMDCOMPL() CMD_Mask {
	return CMD_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(ENCMDCOMPL)}}
}

func (p *SDIO_Periph) NIEN() CMD_Mask {
	return CMD_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(NIEN)}}
}

func (p *SDIO_Periph) CEATACMD() CMD_Mask {
	return CMD_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(CEATACMD)}}
}
...
func (p *SDIO_Periph) STBITERRC() ICR_Mask {
	return ICR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 28)), uint32(STBITERRC)}}
}
...
func (p *SDIO_Periph) CEATAENDC() ICR_Mask {
	return ICR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 28)), uint32(CEATAENDC)}}
}
...
func (p *SDIO_Periph) STBITERRIE() MASK_Mask {
	return MASK_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 32)), uint32(STBITERRIE)}}
}
...
func (p *SDIO_Periph) CEATAENDIE() MASK_Mask {
	return MASK_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 32)), uint32(CEATAENDIE)}}
}
