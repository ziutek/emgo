...
func (p *ADC_Periph) DUALMOD() CR1_Mask {
	return CR1_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(DUALMOD)}}
}
...
func (p *ADC_Periph) CAL() CR2_Mask {
	return CR2_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(CAL)}}
}

func (p *ADC_Periph) RSTCAL() CR2_Mask {
	return CR2_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(RSTCAL)}}
}
...
func (p *ADC_Periph) JEXTTRIG() CR2_Mask {
	return CR2_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(JEXTTRIG)}}
}
...
func (p *ADC_Periph) EXTTRIG() CR2_Mask {
	return CR2_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(EXTTRIG)}}
}
...
func (p *ADC_Periph) TSVREFE() CR2_Mask {
	return CR2_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(TSVREFE)}}
}
