...
func (r *FR1) AtomicStoreBits(mask, b FR1_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
...
func (r *FR2) AtomicStoreBits(mask, b FR2_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
