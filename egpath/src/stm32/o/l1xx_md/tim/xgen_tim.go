...
func (p *TIM_Periph) OCCS() SMCR_Mask {
	return SMCR_Mask{mmio.UM16{(*mmio.U16)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint16(OCCS)}}
}
...
func (p *TIM_Periph) TI1RMP() OR_Mask {
	return OR_Mask{mmio.UM16{(*mmio.U16)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 80)), uint16(TI1RMP)}}
}
