...
const (
	...
	OCCS   SMCR_Bits = 0x01 << 3  //+ OCCS bits (OCref Clear Selection).
...
const (
	TI1RMP   OR_Bits = 0x03 << 0 //+ Option register for TI1 Remapping.
	TI1RMP_0 OR_Bits = 0x01 << 0 //  Bit 0.
	TI1RMP_1 OR_Bits = 0x02 << 0 //  Bit 1.
)
