...
func (p *RTC_Periph) TAMP3TRG() TAFCR_Mask {
	return TAFCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 64)), uint32(TAMP3TRG)}}
}

func (p *RTC_Periph) TAMP3E() TAFCR_Mask {
	return TAFCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 64)), uint32(TAMP3E)}}
}
