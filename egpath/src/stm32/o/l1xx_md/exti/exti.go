...
//  0x08 32  RTSR  Rising edge trigger selection register.
//  0x0C 32  FTSR  Falling edge trigger selection register.
...
const (
	...
	MR20 IMR_Bits = 0x01 << 20 //+ Interrupt Mask on line 20.
	MR21 IMR_Bits = 0x01 << 21 //+ Interrupt Mask on line 21.
	MR22 IMR_Bits = 0x01 << 22 //+ Interrupt Mask on line 22.
...
const (
	...
	MR20 EMR_Bits = 0x01 << 20 //+ Event Mask on line 20.
	MR21 EMR_Bits = 0x01 << 21 //+ Event Mask on line 21.
	MR22 EMR_Bits = 0x01 << 22 //+ Event Mask on line 22.
	MR23 EMR_Bits = 0x01 << 23 //+ Event Mask on line 23.
)
...
const (
	...
	TR20 FTSR_Bits = 0x01 << 20 //+ Falling trigger event configuration bit of line 20.
	TR21 FTSR_Bits = 0x01 << 21 //+ Falling trigger event configuration bit of line 21.
	TR22 FTSR_Bits = 0x01 << 22 //+ Falling trigger event configuration bit of line 22.
...
const (
	PR0  PR_Bits = 0x01 << 0  //+ Pending bit 0.
	PR1  PR_Bits = 0x01 << 1  //+ Pending bit 1.
	PR2  PR_Bits = 0x01 << 2  //+ Pending bit 2.
	PR3  PR_Bits = 0x01 << 3  //+ Pending bit 3.
	PR4  PR_Bits = 0x01 << 4  //+ Pending bit 4.
	PR5  PR_Bits = 0x01 << 5  //+ Pending bit 5.
	PR6  PR_Bits = 0x01 << 6  //+ Pending bit 6.
	PR7  PR_Bits = 0x01 << 7  //+ Pending bit 7.
	PR8  PR_Bits = 0x01 << 8  //+ Pending bit 8.
	PR9  PR_Bits = 0x01 << 9  //+ Pending bit 9.
	PR10 PR_Bits = 0x01 << 10 //+ Pending bit 10.
	PR11 PR_Bits = 0x01 << 11 //+ Pending bit 11.
	PR12 PR_Bits = 0x01 << 12 //+ Pending bit 12.
	PR13 PR_Bits = 0x01 << 13 //+ Pending bit 13.
	PR14 PR_Bits = 0x01 << 14 //+ Pending bit 14.
	PR15 PR_Bits = 0x01 << 15 //+ Pending bit 15.
	PR16 PR_Bits = 0x01 << 16 //+ Pending bit 16.
	PR17 PR_Bits = 0x01 << 17 //+ Pending bit 17.
	PR18 PR_Bits = 0x01 << 18 //+ Pending bit 18.
	PR19 PR_Bits = 0x01 << 19 //+ Pending bit 19.
	PR20 PR_Bits = 0x01 << 20 //+ Pending bit 20.
	PR21 PR_Bits = 0x01 << 21 //+ Pending bit 21.
	PR22 PR_Bits = 0x01 << 22 //+ Pending bit 22.
	PR23 PR_Bits = 0x01 << 23 //+ Pending bit 23.
)
