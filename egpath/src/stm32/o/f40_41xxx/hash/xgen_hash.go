...
func (p *HASH_Periph) INIT() CR_Mask {
	return CR_Mask{mmio.UM32{&p.CR.U32, uint32(INIT)}}
}

func (p *HASH_Periph) DMAE() CR_Mask {
	return CR_Mask{mmio.UM32{&p.CR.U32, uint32(DMAE)}}
}
...
func (p *HASH_Periph) ALGO() CR_Mask {
	return CR_Mask{mmio.UM32{&p.CR.U32, uint32(ALGO)}}
}

func (p *HASH_Periph) NBW() CR_Mask {
	return CR_Mask{mmio.UM32{&p.CR.U32, uint32(NBW)}}
}

func (p *HASH_Periph) DINNE() CR_Mask {
	return CR_Mask{mmio.UM32{&p.CR.U32, uint32(DINNE)}}
}

func (p *HASH_Periph) MDMAT() CR_Mask {
	return CR_Mask{mmio.UM32{&p.CR.U32, uint32(MDMAT)}}
}

func (p *HASH_Periph) LKEY() CR_Mask {
	return CR_Mask{mmio.UM32{&p.CR.U32, uint32(LKEY)}}
}
...
func (r *DIN) AtomicStoreBits(mask, b DIN_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *DIN) AtomicSetBits(mask DIN_Bits)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *DIN) AtomicClearBits(mask DIN_Bits)    { r.U32.AtomicClearBits(uint32(mask)) }
...
func (r *STR) AtomicStoreBits(mask, b STR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *STR) AtomicSetBits(mask STR_Bits)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *STR) AtomicClearBits(mask STR_Bits)    { r.U32.AtomicClearBits(uint32(mask)) }
...
func (p *HASH_Periph) NBW() STR_Mask {
	return STR_Mask{mmio.UM32{&p.STR.U32, uint32(NBW)}}
}

func (p *HASH_Periph) DCAL() STR_Mask {
	return STR_Mask{mmio.UM32{&p.STR.U32, uint32(DCAL)}}
}
...
func (p *HASH_Periph) DINIM() IMR_Mask {
	return IMR_Mask{mmio.UM32{&p.IMR.U32, uint32(DINIM)}}
}

func (p *HASH_Periph) DCIM() IMR_Mask {
	return IMR_Mask{mmio.UM32{&p.IMR.U32, uint32(DCIM)}}
}
...
func (p *HASH_Periph) DINIS() SR_Mask {
	return SR_Mask{mmio.UM32{&p.SR.U32, uint32(DINIS)}}
}

func (p *HASH_Periph) DCIS() SR_Mask {
	return SR_Mask{mmio.UM32{&p.SR.U32, uint32(DCIS)}}
}

func (p *HASH_Periph) DMAS() SR_Mask {
	return SR_Mask{mmio.UM32{&p.SR.U32, uint32(DMAS)}}
}
