...
const (
	...
	PPRE                     CFGR_Bits = 0x07 << 8  //+ PRE[2:0] bits (APB prescaler).
	PPRE_DIV1                CFGR_Bits = 0x00 << 8  //  HCLK not divided.
	PPRE_DIV2                CFGR_Bits = 0x04 << 8  //  HCLK divided by 2.
	PPRE_DIV4                CFGR_Bits = 0x05 << 8  //  HCLK divided by 4.
	PPRE_DIV8                CFGR_Bits = 0x06 << 8  //  HCLK divided by 8.
	PPRE_DIV16               CFGR_Bits = 0x07 << 8  //  HCLK divided by 16.
	ADCPRE                   CFGR_Bits = 0x01 << 14 //+ ADCPRE bit (ADC prescaler).
	ADCPRE_DIV2              CFGR_Bits = 0x00 << 14 //  PCLK divided by 2.
	ADCPRE_DIV4              CFGR_Bits = 0x01 << 14 //  PCLK divided by 4.
	PLLSRC                   CFGR_Bits = 0x01 << 16 //+ PLL entry clock source.
	PLLSRC_HSI_DIV2          CFGR_Bits = 0x00 << 16 //  HSI clock divided by 2 selected as PLL entry clock source.
	PLLSRC_HSE_PREDIV        CFGR_Bits = 0x01 << 16 //  HSE/PREDIV clock selected as PLL entry clock source.
	...
	MCO                      CFGR_Bits = 0x0F << 24 //+ MCO[3:0] bits (Microcontroller Clock Output).
	MCO_NOCLOCK              CFGR_Bits = 0x00 << 24 //  No clock.
	MCO_HSI14                CFGR_Bits = 0x01 << 24 //  HSI14 clock selected as MCO source.
...
const (
	...
	HSI14RDYF  CIR_Bits = 0x01 << 5  //+ HSI14 Ready Interrupt flag.
	...
	HSI14RDYIE CIR_Bits = 0x01 << 13 //+ HSI14 Ready Interrupt Enable.
	...
	HSI14RDYC  CIR_Bits = 0x01 << 21 //+ HSI14 Ready Interrupt Clear.
...
const (
	...
	ADCRST    APB2RSTR_Bits = 0x01 << 9  //+ ADC reset.
	...
	DBGMCURST APB2RSTR_Bits = 0x01 << 22 //+ DBGMCU reset.
)
...
const (
	...
	TIM14RST APB1RSTR_Bits = 0x01 << 8  //+ Timer 14 reset.
...
const (
	DMAEN   AHBENR_Bits = 0x01 << 0  //+ DMA1 clock enable.
...
const (
	SYSCFGCOMPEN APB2ENR_Bits = 0x01 << 0  //+ SYSCFG and comparator clock enable.
	ADCEN        APB2ENR_Bits = 0x01 << 9  //+ ADC1 clock enable.
	...
	DBGMCUEN     APB2ENR_Bits = 0x01 << 22 //+ DBGMCU clock enable.
)
...
const (
	...
	TIM14EN APB1ENR_Bits = 0x01 << 8  //+ Timer 14 clock enable.
	WWDGEN  APB1ENR_Bits = 0x01 << 11 //+ Window Watchdog clock enable.
	I2C1EN  APB1ENR_Bits = 0x01 << 21 //+ I2C1 clock enable.
...
const (
	...
	USART1SW_PCLK   CFGR3_Bits = 0x00 << 0 //  PCLK clock used as USART1 clock source.
...
const (
	HSI14ON   CR2_Bits = 0x01 << 0 //+ Internal High Speed 14MHz clock enable.
	HSI14RDY  CR2_Bits = 0x01 << 1 //+ Internal High Speed 14MHz clock ready flag.
	HSI14DIS  CR2_Bits = 0x01 << 2 //+ Internal High Speed 14MHz clock disable.
	HSI14TRIM CR2_Bits = 0x1F << 3 //+ Internal High Speed 14MHz clock trimming.
	HSI14CAL  CR2_Bits = 0xFF << 8 //+ Internal High Speed 14MHz clock Calibration.
)
