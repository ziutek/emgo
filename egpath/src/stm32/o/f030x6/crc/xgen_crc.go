...
func (r *INIT) AtomicStoreBits(mask, b INIT_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
...
type RESERVED3 struct{ mmio.U32 }

func (r *RESERVED3) Bits(mask RESERVED3_Bits) RESERVED3_Bits {
	return RESERVED3_Bits(r.U32.Bits(uint32(mask)))
}
func (r *RESERVED3) StoreBits(mask, b RESERVED3_Bits) { r.U32.StoreBits(uint32(mask), uint32(b)) }
func (r *RESERVED3) SetBits(mask RESERVED3_Bits)      { r.U32.SetBits(uint32(mask)) }
func (r *RESERVED3) ClearBits(mask RESERVED3_Bits)    { r.U32.ClearBits(uint32(mask)) }
func (r *RESERVED3) Load() RESERVED3_Bits             { return RESERVED3_Bits(r.U32.Load()) }
func (r *RESERVED3) Store(b RESERVED3_Bits)           { r.U32.Store(uint32(b)) }

func (r *RESERVED3) AtomicStoreBits(mask, b RESERVED3_Bits) {
	r.U32.AtomicStoreBits(uint32(mask), uint32(b))
}
func (r *RESERVED3) AtomicSetBits(mask RESERVED3_Bits)   { r.U32.AtomicSetBits(uint32(mask)) }
func (r *RESERVED3) AtomicClearBits(mask RESERVED3_Bits) { r.U32.AtomicClearBits(uint32(mask)) }

type RESERVED3_Mask struct{ mmio.UM32 }

func (rm RESERVED3_Mask) Load() RESERVED3_Bits   { return RESERVED3_Bits(rm.UM32.Load()) }
func (rm RESERVED3_Mask) Store(b RESERVED3_Bits) { rm.UM32.Store(uint32(b)) }
