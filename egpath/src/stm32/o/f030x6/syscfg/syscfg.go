...
const (
	...
	I2C_FMP_I2C1     CFGR1 = 0x01 << 20 //+ Enable Fast Mode Plus on PB10, PB11, PF6 and PF7.
	I2C_FMP_PA9      CFGR1 = 0x01 << 22 //+ Enable Fast Mode Plus on PA9.
	I2C_FMP_PA10     CFGR1 = 0x01 << 23 //+ Enable Fast Mode Plus on PA10.
)
