...
const (
	CRCPOLY CRCPR_Bits = 0xFFFFFFFF << 0 //+ CRC polynomial register.
)
...
const (
	RXCRC RXCRCR_Bits = 0xFFFFFFFF << 0 //+ Rx CRC Register.
)
...
const (
	TXCRC TXCRCR_Bits = 0xFFFFFFFF << 0 //+ Tx CRC Register.
)
...
const (
	I2SMOD I2SCFGR_Bits = 0x01 << 11 //+ Keep for compatibility.
)
