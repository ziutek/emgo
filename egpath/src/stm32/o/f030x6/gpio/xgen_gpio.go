...
func (p *GPIO_Periph) OSPEEDR0() OSPEEDR_Mask {
	return OSPEEDR_Mask{mmio.UM32{&p.OSPEEDR.U32, uint32(OSPEEDR0)}}
}

func (p *GPIO_Periph) OSPEEDR1() OSPEEDR_Mask {
	return OSPEEDR_Mask{mmio.UM32{&p.OSPEEDR.U32, uint32(OSPEEDR1)}}
}

func (p *GPIO_Periph) OSPEEDR2() OSPEEDR_Mask {
	return OSPEEDR_Mask{mmio.UM32{&p.OSPEEDR.U32, uint32(OSPEEDR2)}}
}

func (p *GPIO_Periph) OSPEEDR3() OSPEEDR_Mask {
	return OSPEEDR_Mask{mmio.UM32{&p.OSPEEDR.U32, uint32(OSPEEDR3)}}
}

func (p *GPIO_Periph) OSPEEDR4() OSPEEDR_Mask {
	return OSPEEDR_Mask{mmio.UM32{&p.OSPEEDR.U32, uint32(OSPEEDR4)}}
}

func (p *GPIO_Periph) OSPEEDR5() OSPEEDR_Mask {
	return OSPEEDR_Mask{mmio.UM32{&p.OSPEEDR.U32, uint32(OSPEEDR5)}}
}

func (p *GPIO_Periph) OSPEEDR6() OSPEEDR_Mask {
	return OSPEEDR_Mask{mmio.UM32{&p.OSPEEDR.U32, uint32(OSPEEDR6)}}
}

func (p *GPIO_Periph) OSPEEDR7() OSPEEDR_Mask {
	return OSPEEDR_Mask{mmio.UM32{&p.OSPEEDR.U32, uint32(OSPEEDR7)}}
}

func (p *GPIO_Periph) OSPEEDR8() OSPEEDR_Mask {
	return OSPEEDR_Mask{mmio.UM32{&p.OSPEEDR.U32, uint32(OSPEEDR8)}}
}

func (p *GPIO_Periph) OSPEEDR9() OSPEEDR_Mask {
	return OSPEEDR_Mask{mmio.UM32{&p.OSPEEDR.U32, uint32(OSPEEDR9)}}
}

func (p *GPIO_Periph) OSPEEDR10() OSPEEDR_Mask {
	return OSPEEDR_Mask{mmio.UM32{&p.OSPEEDR.U32, uint32(OSPEEDR10)}}
}

func (p *GPIO_Periph) OSPEEDR11() OSPEEDR_Mask {
	return OSPEEDR_Mask{mmio.UM32{&p.OSPEEDR.U32, uint32(OSPEEDR11)}}
}

func (p *GPIO_Periph) OSPEEDR12() OSPEEDR_Mask {
	return OSPEEDR_Mask{mmio.UM32{&p.OSPEEDR.U32, uint32(OSPEEDR12)}}
}

func (p *GPIO_Periph) OSPEEDR13() OSPEEDR_Mask {
	return OSPEEDR_Mask{mmio.UM32{&p.OSPEEDR.U32, uint32(OSPEEDR13)}}
}

func (p *GPIO_Periph) OSPEEDR14() OSPEEDR_Mask {
	return OSPEEDR_Mask{mmio.UM32{&p.OSPEEDR.U32, uint32(OSPEEDR14)}}
}

func (p *GPIO_Periph) OSPEEDR15() OSPEEDR_Mask {
	return OSPEEDR_Mask{mmio.UM32{&p.OSPEEDR.U32, uint32(OSPEEDR15)}}
}
