...
func (r *RESERVED1) AtomicStoreBits(mask, b RESERVED1_Bits) {
	r.U32.AtomicStoreBits(uint32(mask), uint32(b))
}
...
func (r *OPTR) AtomicStoreBits(mask, b OPTR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
...
func (r *PCROP1SR) AtomicStoreBits(mask, b PCROP1SR_Bits) {
	r.U32.AtomicStoreBits(uint32(mask), uint32(b))
}
...
func (r *PCROP1ER) AtomicStoreBits(mask, b PCROP1ER_Bits) {
	r.U32.AtomicStoreBits(uint32(mask), uint32(b))
}
...
func (r *WRP1AR) AtomicStoreBits(mask, b WRP1AR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
...
func (r *WRP1BR) AtomicStoreBits(mask, b WRP1BR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
...
func (r *PCROP2SR) AtomicStoreBits(mask, b PCROP2SR_Bits) {
	r.U32.AtomicStoreBits(uint32(mask), uint32(b))
}
...
func (r *PCROP2ER) AtomicStoreBits(mask, b PCROP2ER_Bits) {
	r.U32.AtomicStoreBits(uint32(mask), uint32(b))
}
...
func (r *WRP2AR) AtomicStoreBits(mask, b WRP2AR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
...
func (r *WRP2BR) AtomicStoreBits(mask, b WRP2BR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
