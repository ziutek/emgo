...
func (mask SHSR1) J(v int) SHSR1 {
	return SHSR1(bits.MakeField32(v, uint32(mask)))
}
...
func (mask SHSR2) J(v int) SHSR2 {
	return SHSR2(bits.MakeField32(v, uint32(mask)))
}
...
func (mask SHHR) J(v int) SHHR {
	return SHHR(bits.MakeField32(v, uint32(mask)))
}
...
func (mask SHRR) J(v int) SHRR {
	return SHRR(bits.MakeField32(v, uint32(mask)))
}
