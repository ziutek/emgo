...
func (r *PCR) AtomicStoreBits(mask, b PCR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *PCR) AtomicSetBits(mask PCR_Bits)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *PCR) AtomicClearBits(mask PCR_Bits)    { r.U32.AtomicClearBits(uint32(mask)) }
...
func (r *PMEM) AtomicStoreBits(mask, b PMEM_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *PMEM) AtomicSetBits(mask PMEM_Bits)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *PMEM) AtomicClearBits(mask PMEM_Bits)    { r.U32.AtomicClearBits(uint32(mask)) }
...
func (p *FMC_Bank3_Periph) MEMSET() PMEM_Mask {
	return PMEM_Mask{mmio.UM32{&p.PMEM.U32, uint32(MEMSET)}}
}

func (p *FMC_Bank3_Periph) MEMWAIT() PMEM_Mask {
	return PMEM_Mask{mmio.UM32{&p.PMEM.U32, uint32(MEMWAIT)}}
}

func (p *FMC_Bank3_Periph) MEMHOLD() PMEM_Mask {
	return PMEM_Mask{mmio.UM32{&p.PMEM.U32, uint32(MEMHOLD)}}
}

func (p *FMC_Bank3_Periph) MEMHIZ() PMEM_Mask {
	return PMEM_Mask{mmio.UM32{&p.PMEM.U32, uint32(MEMHIZ)}}
}
...
func (r *PATT) AtomicStoreBits(mask, b PATT_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *PATT) AtomicSetBits(mask PATT_Bits)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *PATT) AtomicClearBits(mask PATT_Bits)    { r.U32.AtomicClearBits(uint32(mask)) }
...
func (p *FMC_Bank3_Periph) ATTSET() PATT_Mask {
	return PATT_Mask{mmio.UM32{&p.PATT.U32, uint32(ATTSET)}}
}

func (p *FMC_Bank3_Periph) ATTWAIT() PATT_Mask {
	return PATT_Mask{mmio.UM32{&p.PATT.U32, uint32(ATTWAIT)}}
}

func (p *FMC_Bank3_Periph) ATTHOLD() PATT_Mask {
	return PATT_Mask{mmio.UM32{&p.PATT.U32, uint32(ATTHOLD)}}
}

func (p *FMC_Bank3_Periph) ATTHIZ() PATT_Mask {
	return PATT_Mask{mmio.UM32{&p.PATT.U32, uint32(ATTHIZ)}}
}
...
func (r *ECCR) AtomicStoreBits(mask, b ECCR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
...
func (p *FMC_Bank3_Periph) ECC() ECCR_Mask {
	return ECCR_Mask{mmio.UM32{&p.ECCR.U32, uint32(ECC)}}
}
