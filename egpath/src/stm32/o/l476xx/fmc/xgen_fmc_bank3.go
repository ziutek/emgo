...
func (mask PCR) J(v int) PCR {
	return PCR(bits.Make32(v, uint32(mask)))
}
...
func (mask PMEM) J(v int) PMEM {
	return PMEM(bits.Make32(v, uint32(mask)))
}
...
func (p *FMC_Bank3_Periph) MEMSET() RMPMEM {
	return RMPMEM{mmio.UM32{&p.PMEM.U32, uint32(MEMSET)}}
}

func (p *FMC_Bank3_Periph) MEMWAIT() RMPMEM {
	return RMPMEM{mmio.UM32{&p.PMEM.U32, uint32(MEMWAIT)}}
}

func (p *FMC_Bank3_Periph) MEMHOLD() RMPMEM {
	return RMPMEM{mmio.UM32{&p.PMEM.U32, uint32(MEMHOLD)}}
}

func (p *FMC_Bank3_Periph) MEMHIZ() RMPMEM {
	return RMPMEM{mmio.UM32{&p.PMEM.U32, uint32(MEMHIZ)}}
}
...
func (mask PATT) J(v int) PATT {
	return PATT(bits.Make32(v, uint32(mask)))
}
...
func (p *FMC_Bank3_Periph) ATTSET() RMPATT {
	return RMPATT{mmio.UM32{&p.PATT.U32, uint32(ATTSET)}}
}

func (p *FMC_Bank3_Periph) ATTWAIT() RMPATT {
	return RMPATT{mmio.UM32{&p.PATT.U32, uint32(ATTWAIT)}}
}

func (p *FMC_Bank3_Periph) ATTHOLD() RMPATT {
	return RMPATT{mmio.UM32{&p.PATT.U32, uint32(ATTHOLD)}}
}

func (p *FMC_Bank3_Periph) ATTHIZ() RMPATT {
	return RMPATT{mmio.UM32{&p.PATT.U32, uint32(ATTHIZ)}}
}
...
func (p *FMC_Bank3_Periph) ECC() RMECCR {
	return RMECCR{mmio.UM32{&p.ECCR.U32, uint32(ECC)}}
}
