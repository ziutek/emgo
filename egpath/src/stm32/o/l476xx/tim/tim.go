...
const (
	...
	OIS5  CR2_Bits = 0x01 << 16 //+ Output Idle state 5 (OC5 output).
	OIS6  CR2_Bits = 0x01 << 18 //+ Output Idle state 6 (OC6 output).
...
const (
	...
	B2IF  SR_Bits = 0x01 << 8  //+ Break 2 interrupt Flag.
	...
	SBIF  SR_Bits = 0x01 << 13 //+ System Break interrupt Flag.
...
const (
	...
	B2G  EGR_Bits = 0x01 << 8 //+ Break 2 Generation.
)
...
const (
	...
	OC1CE  CCMR1_Bits = 0x01 << 7    //+ Output Compare 1 Clear Enable.
...
const (
	...
	BKE  BDTR_Bits = 0x01 << 12 //+ Break enable for Break 1.
	BKP  BDTR_Bits = 0x01 << 13 //+ Break Polarity for Break 1.
	AOE  BDTR_Bits = 0x01 << 14 //+ Automatic Output enable.
	MOE  BDTR_Bits = 0x01 << 15 //+ Main Output enable.
	BKF  BDTR_Bits = 0x0F << 16 //+ Break Filter for Break 1.
	BK2F BDTR_Bits = 0x0F << 20 //+ Break Filter for Break 2.
	BK2E BDTR_Bits = 0x01 << 24 //+ Break enable for Break 2.
	BK2P BDTR_Bits = 0x01 << 25 //+ Break Polarity for Break 2.
)
...
const (
	...
	OC5M  CCMR3_Bits = 0x1007 << 4  //+ OC5M[3:0] bits (Output Compare 5 Mode).
	...
	OC6M  CCMR3_Bits = 0x1007 << 12 //+ OC6M[3:0] bits (Output Compare 6 Mode).
