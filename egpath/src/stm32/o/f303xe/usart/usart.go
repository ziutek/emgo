...
//  0x0C 16  BRR  Baud rate register.
//  0x10 16  GTPR Guard time and prescaler register.
//  0x14 32  RTOR Receiver Time Out register.
//  0x18 16  RQR  Request register.
...
const (
	...
	DEDT_0 CR1_Bits = 0x01 << 16 //  Bit 0.
	DEDT_1 CR1_Bits = 0x02 << 16 //  Bit 1.
	DEDT_2 CR1_Bits = 0x04 << 16 //  Bit 2.
	DEDT_3 CR1_Bits = 0x08 << 16 //  Bit 3.
	DEDT_4 CR1_Bits = 0x10 << 16 //  Bit 4.
	DEAT   CR1_Bits = 0x1F << 21 //+ DEAT[4:0] bits (Driver Enable Assertion Time).
	DEAT_0 CR1_Bits = 0x01 << 21 //  Bit 0.
	DEAT_1 CR1_Bits = 0x02 << 21 //  Bit 1.
	DEAT_2 CR1_Bits = 0x04 << 21 //  Bit 2.
	DEAT_3 CR1_Bits = 0x08 << 21 //  Bit 3.
	DEAT_4 CR1_Bits = 0x10 << 21 //  Bit 4.
...
const (
	...
	ABRMODE_0 CR2_Bits = 0x01 << 21 //  Bit 0.
	ABRMODE_1 CR2_Bits = 0x02 << 21 //  Bit 1.
...
const (
	...
	SCARCNT_0 CR3_Bits = 0x01 << 17 //  Bit 0.
	SCARCNT_1 CR3_Bits = 0x02 << 17 //  Bit 1.
	SCARCNT_2 CR3_Bits = 0x04 << 17 //  Bit 2.
	WUS       CR3_Bits = 0x03 << 20 //+ WUS[1:0] bits (Wake UP Interrupt Flag Selection).
	WUS_0     CR3_Bits = 0x01 << 20 //  Bit 0.
	WUS_1     CR3_Bits = 0x02 << 20 //  Bit 1.
...
const (
	...
	LBD   ISR_Bits = 0x01 << 8  //+ LIN Break Detection Flag.
