...
func (p *USART_Periph) M0() CR1_Mask {
	return CR1_Mask{mmio.UM32{&p.CR1.U32, uint32(M0)}}
}
...
func (p *USART_Periph) M1() CR1_Mask {
	return CR1_Mask{mmio.UM32{&p.CR1.U32, uint32(M1)}}
}
