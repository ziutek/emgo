...
const (
	...
	PLLSRC                   CFGR_Bits = 0x03 << 15 //+ PLL entry clock source.
	PLLSRC_HSI_PREDIV        CFGR_Bits = 0x01 << 15 //  HSI/PREDIV clock as PLL entry clock source.
	PLLSRC_HSE_PREDIV        CFGR_Bits = 0x02 << 15 //  HSE/PREDIV clock selected as PLL entry clock source.
	PLLXTPRE                 CFGR_Bits = 0x01 << 17 //+ HSE divider for PLL entry.
	PLLXTPRE_HSE_PREDIV_DIV1 CFGR_Bits = 0x00 << 17 //  HSE/PREDIV clock not divided for PLL entry.
	PLLXTPRE_HSE_PREDIV_DIV2 CFGR_Bits = 0x01 << 17 //  HSE/PREDIV clock divided by 2 for PLL entry.
	PLLMUL                   CFGR_Bits = 0x0F << 18 //+ PLLMUL[3:0] bits (PLL multiplication factor).
	PLLMUL2                  CFGR_Bits = 0x00 << 18 //  PLL input clock*2.
	PLLMUL3                  CFGR_Bits = 0x01 << 18 //  PLL input clock*3.
	PLLMUL4                  CFGR_Bits = 0x02 << 18 //  PLL input clock*4.
	PLLMUL5                  CFGR_Bits = 0x03 << 18 //  PLL input clock*5.
	PLLMUL6                  CFGR_Bits = 0x04 << 18 //  PLL input clock*6.
	PLLMUL7                  CFGR_Bits = 0x05 << 18 //  PLL input clock*7.
	PLLMUL8                  CFGR_Bits = 0x06 << 18 //  PLL input clock*8.
	PLLMUL9                  CFGR_Bits = 0x07 << 18 //  PLL input clock*9.
	PLLMUL10                 CFGR_Bits = 0x08 << 18 //  PLL input clock10.
	PLLMUL11                 CFGR_Bits = 0x09 << 18 //  PLL input clock*11.
	PLLMUL12                 CFGR_Bits = 0x0A << 18 //  PLL input clock*12.
	PLLMUL13                 CFGR_Bits = 0x0B << 18 //  PLL input clock*13.
	PLLMUL14                 CFGR_Bits = 0x0C << 18 //  PLL input clock*14.
	PLLMUL15                 CFGR_Bits = 0x0D << 18 //  PLL input clock*15.
	PLLMUL16                 CFGR_Bits = 0x0E << 18 //  PLL input clock*16.
	USBPRE                   CFGR_Bits = 0x01 << 22 //+ USB prescaler.
	USBPRE_DIV1_5            CFGR_Bits = 0x00 << 22 //  USB prescaler is PLL clock divided by 1.5.
	USBPRE_DIV1              CFGR_Bits = 0x01 << 22 //  USB prescaler is PLL clock divided by 1.
	I2SSRC                   CFGR_Bits = 0x01 << 23 //+ I2S external clock source selection.
	I2SSRC_SYSCLK            CFGR_Bits = 0x00 << 23 //  System clock selected as I2S clock source.
	I2SSRC_EXT               CFGR_Bits = 0x01 << 23 //  External clock selected as I2S clock source.
	...
	MCOPRE                   CFGR_Bits = 0x07 << 28 //+ MCOPRE[3:0] bits (Microcontroller Clock Output Prescaler).
	...
	MCOPRE_DIV32             CFGR_Bits = 0x05 << 28 //  MCO is divided by 32.
	MCOPRE_DIV64             CFGR_Bits = 0x06 << 28 //  MCO is divided by 64.
	MCOPRE_DIV128            CFGR_Bits = 0x07 << 28 //  MCO is divided by 128.
	PLLNODIV                 CFGR_Bits = 0x01 << 31 //+ Do not divide PLL to MCO.
)
...
const (
	...
	TIM1RST   APB2RSTR_Bits = 0x01 << 11 //+ TIM1 reset.
...
const (
	...
	CANRST    APB1RSTR_Bits = 0x01 << 25 //+ CAN reset.
...
const (
	...
	TSCEN   AHBENR_Bits = 0x01 << 24 //+ TS clock enable.
	ADC12EN AHBENR_Bits = 0x01 << 28 //+ ADC1/ ADC2 clock enable.
	ADC34EN AHBENR_Bits = 0x01 << 29 //+ ADC3/ ADC4 clock enable.
)
...
const (
	...
	CANEN    APB1ENR_Bits = 0x01 << 25 //+ CAN clock enable.
	PWREN    APB1ENR_Bits = 0x01 << 28 //+ PWR clock enable.
	DAC1EN   APB1ENR_Bits = 0x01 << 29 //+ DAC 1 clock enable.
...
const (
	LSE            BDCR_Bits = 0x07 << 0  //+ External Low Speed oscillator [2:0] bits.
	LSEON          BDCR_Bits = 0x01 << 0  //  External Low Speed oscillator enable.
	LSERDY         BDCR_Bits = 0x02 << 0  //  External Low Speed oscillator Ready.
	LSEBYP         BDCR_Bits = 0x04 << 0  //  External Low Speed oscillator Bypass.
...
const (
	...
	V18PWRRSTF CSR_Bits = 0x01 << 23 //+ V1.8 power domain reset flag.
...
const (
	...
	GPIODRST AHBRSTR_Bits = 0x01 << 20 //+ GPIOD reset.
	...
	TSCRST   AHBRSTR_Bits = 0x01 << 24 //+ TSC reset.
	ADC12RST AHBRSTR_Bits = 0x01 << 28 //+ ADC1 & ADC2 reset.
	ADC34RST AHBRSTR_Bits = 0x01 << 29 //+ ADC3 & ADC4 reset.
)
...
const (
	PREDIV          CFGR2_Bits = 0x0F << 0 //+ PREDIV[3:0] bits.
	PREDIV_DIV1     CFGR2_Bits = 0x00 << 0 //  PREDIV input clock not divided.
	PREDIV_DIV2     CFGR2_Bits = 0x01 << 0 //  PREDIV input clock divided by 2.
	PREDIV_DIV3     CFGR2_Bits = 0x02 << 0 //  PREDIV input clock divided by 3.
	PREDIV_DIV4     CFGR2_Bits = 0x03 << 0 //  PREDIV input clock divided by 4.
	PREDIV_DIV5     CFGR2_Bits = 0x04 << 0 //  PREDIV input clock divided by 5.
	PREDIV_DIV6     CFGR2_Bits = 0x05 << 0 //  PREDIV input clock divided by 6.
	PREDIV_DIV7     CFGR2_Bits = 0x06 << 0 //  PREDIV input clock divided by 7.
	PREDIV_DIV8     CFGR2_Bits = 0x07 << 0 //  PREDIV input clock divided by 8.
	PREDIV_DIV9     CFGR2_Bits = 0x08 << 0 //  PREDIV input clock divided by 9.
	PREDIV_DIV10    CFGR2_Bits = 0x09 << 0 //  PREDIV input clock divided by 10.
	PREDIV_DIV11    CFGR2_Bits = 0x0A << 0 //  PREDIV input clock divided by 11.
	PREDIV_DIV12    CFGR2_Bits = 0x0B << 0 //  PREDIV input clock divided by 12.
	PREDIV_DIV13    CFGR2_Bits = 0x0C << 0 //  PREDIV input clock divided by 13.
	PREDIV_DIV14    CFGR2_Bits = 0x0D << 0 //  PREDIV input clock divided by 14.
	PREDIV_DIV15    CFGR2_Bits = 0x0E << 0 //  PREDIV input clock divided by 15.
	PREDIV_DIV16    CFGR2_Bits = 0x0F << 0 //  PREDIV input clock divided by 16.
...
const (
	...
	USART1SW_PCLK2  CFGR3_Bits = 0x00 << 0  //  PCLK2 clock used as USART1 clock source.
	USART1SW_SYSCLK CFGR3_Bits = 0x01 << 0  //  System clock selected as USART1 clock source.
	USART1SW_LSE    CFGR3_Bits = 0x02 << 0  //  LSE oscillator clock used as USART1 clock source.
	USART1SW_HSI    CFGR3_Bits = 0x03 << 0  //  HSI oscillator clock used as USART1 clock source.
	...
	I2C1SW_HSI      CFGR3_Bits = 0x00 << 4  //  HSI oscillator clock used as I2C1 clock source.
	I2C1SW_SYSCLK   CFGR3_Bits = 0x01 << 4  //  System clock selected as I2C1 clock source.
	I2C2SW_HSI      CFGR3_Bits = 0x00 << 4  //  HSI oscillator clock used as I2C2 clock source.
	I2C2SW_SYSCLK   CFGR3_Bits = 0x02 << 4  //  System clock selected as I2C2 clock source.
	I2C3SW_HSI      CFGR3_Bits = 0x00 << 4  //  HSI oscillator clock used as I2C3 clock source.
	I2C3SW_SYSCLK   CFGR3_Bits = 0x04 << 4  //  System clock selected as I2C3 clock source.
	TIMSW           CFGR3_Bits = 0xAF << 8  //+ TIMSW bits.
	...
	TIM20SW         CFGR3_Bits = 0x80 << 8  //  TIM20SW bits.
	TIM2SW          CFGR3_Bits = 0x01 << 24 //+ TIM2SW bits.
	TIM34SW         CFGR3_Bits = 0x01 << 25 //+ TIM34SW bits.
	TIM1SW_PCLK2    CFGR3_Bits = 0x00 << 25 //  PCLK2 used as TIM1 clock source.
	TIM1SW_PLL      CFGR3_Bits = 0x01 << 8  //  PLL clock used as TIM1 clock source.
	TIM8SW_PCLK2    CFGR3_Bits = 0x00 << 25 //  PCLK2 used as TIM8 clock source.
	TIM8SW_PLL      CFGR3_Bits = 0x02 << 8  //  PLL clock used as TIM8 clock source.
	TIM15SW_PCLK2   CFGR3_Bits = 0x00 << 25 //  PCLK2 used as TIM15 clock source.
	TIM15SW_PLL     CFGR3_Bits = 0x04 << 8  //  PLL clock used as TIM15 clock source.
	TIM16SW_PCLK2   CFGR3_Bits = 0x00 << 25 //  PCLK2 used as TIM16 clock source.
	TIM16SW_PLL     CFGR3_Bits = 0x08 << 8  //  PLL clock used as TIM16 clock source.
	TIM17SW_PCLK2   CFGR3_Bits = 0x00 << 25 //  PCLK2 used as TIM17 clock source.
	TIM17SW_PLL     CFGR3_Bits = 0x20 << 8  //  PLL clock used as TIM17 clock source.
	TIM20SW_PCLK2   CFGR3_Bits = 0x00 << 25 //  PCLK2 used as TIM20 clock source.
	TIM20SW_PLL     CFGR3_Bits = 0x80 << 8  //  PLL clock used as TIM20 clock source.
	USART2SW        CFGR3_Bits = 0x03 << 16 //+ USART2SW[1:0] bits.
	USART2SW_PCLK   CFGR3_Bits = 0x00 << 16 //  PCLK1 clock used as USART2 clock source.
	USART2SW_SYSCLK CFGR3_Bits = 0x01 << 16 //  System clock selected as USART2 clock source.
	USART2SW_LSE    CFGR3_Bits = 0x02 << 16 //  LSE oscillator clock used as USART2 clock source.
	USART2SW_HSI    CFGR3_Bits = 0x03 << 16 //  HSI oscillator clock used as USART2 clock source.
	USART3SW        CFGR3_Bits = 0x03 << 18 //+ USART3SW[1:0] bits.
	USART3SW_PCLK   CFGR3_Bits = 0x00 << 18 //  PCLK1 clock used as USART3 clock source.
	USART3SW_SYSCLK CFGR3_Bits = 0x01 << 18 //  System clock selected as USART3 clock source.
	USART3SW_LSE    CFGR3_Bits = 0x02 << 18 //  LSE oscillator clock used as USART3 clock source.
	USART3SW_HSI    CFGR3_Bits = 0x03 << 18 //  HSI oscillator clock used as USART3 clock source.
	UART4SW         CFGR3_Bits = 0x03 << 20 //+ UART4SW[1:0] bits.
	UART4SW_PCLK    CFGR3_Bits = 0x00 << 20 //  PCLK1 clock used as UART4 clock source.
	UART4SW_SYSCLK  CFGR3_Bits = 0x01 << 20 //  System clock selected as UART4 clock source.
	UART4SW_LSE     CFGR3_Bits = 0x02 << 20 //  LSE oscillator clock used as UART4 clock source.
	UART4SW_HSI     CFGR3_Bits = 0x03 << 20 //  HSI oscillator clock used as UART4 clock source.
	UART5SW         CFGR3_Bits = 0x03 << 22 //+ UART5SW[1:0] bits.
	UART5SW_PCLK    CFGR3_Bits = 0x00 << 22 //  PCLK1 clock used as UART5 clock source.
	UART5SW_SYSCLK  CFGR3_Bits = 0x01 << 22 //  System clock selected as UART5 clock source.
	UART5SW_LSE     CFGR3_Bits = 0x02 << 22 //  LSE oscillator clock used as UART5 clock source.
	UART5SW_HSI     CFGR3_Bits = 0x03 << 22 //  HSI oscillator clock used as UART5 clock source.
	TIM2SW_PCLK1    CFGR3_Bits = 0x00 << 22 //  PCLK1 used as TIM2 clock source.
	TIM2SW_PLL      CFGR3_Bits = 0x01 << 24 //  PLL clock used as TIM2 clock source.
	TIM34SW_PCLK1   CFGR3_Bits = 0x00 << 22 //  PCLK1 used as TIM3/TIM4 clock source.
	TIM34SW_PLL     CFGR3_Bits = 0x01 << 25 //  PLL clock used as TIM3/TIM4 clock source.
)
