...
const (
	...
	CCMDATARAM_BASE    uintptr = 0x10000000 // CCM(core coupled memory) data RAM(16 KB) base address in the alias region
	...
	CCMDATARAM_BB_BASE uintptr = 0x12000000 // CCM(core coupled memory) data RAM base address in the bit-band region
...
const (
	...
	CAN1_BASE    uintptr = APB1PERIPH_BASE + 0x00006400
	...
	DAC2_BASE    uintptr = APB1PERIPH_BASE + 0x00009800
...
const (
	...
	COMP_BASE          uintptr = APB2PERIPH_BASE + 0x0000001C
	...
	OPAMP_BASE         uintptr = APB2PERIPH_BASE + 0x00000038
	...
	HRTIM1_BASE        uintptr = APB2PERIPH_BASE + 0x00007400
	HRTIM1_TIMA_BASE   uintptr = HRTIM1_BASE + 0x00000080
	HRTIM1_TIMB_BASE   uintptr = HRTIM1_BASE + 0x00000100
	HRTIM1_TIMC_BASE   uintptr = HRTIM1_BASE + 0x00000180
	HRTIM1_TIMD_BASE   uintptr = HRTIM1_BASE + 0x00000200
	HRTIM1_TIME_BASE   uintptr = HRTIM1_BASE + 0x00000280
	HRTIM1_COMMON_BASE uintptr = HRTIM1_BASE + 0x00000380
)
...
// AHB3 peripherals
const (
	ADC1_BASE   uintptr = AHB3PERIPH_BASE + 0x0000
	ADC2_BASE   uintptr = AHB3PERIPH_BASE + 0x0100
	ADC1_2_BASE uintptr = AHB3PERIPH_BASE + 0x0300
	ADC3_BASE   uintptr = AHB3PERIPH_BASE + 0x0400
	ADC4_BASE   uintptr = AHB3PERIPH_BASE + 0x0500
	ADC3_4_BASE uintptr = AHB3PERIPH_BASE + 0x0700
)
...
const (
	...
	FMC_Bank2_R_BASE  uintptr = FMC_R_BASE + 0x0060
