...
func (p *USB_OTG_Global_Periph) HNGSCS() GOTGCTL_Mask {
	return GOTGCTL_Mask{mmio.UM32{&p.GOTGCTL.U32, uint32(HNGSCS)}}
}

func (p *USB_OTG_Global_Periph) HNPRQ() GOTGCTL_Mask {
	return GOTGCTL_Mask{mmio.UM32{&p.GOTGCTL.U32, uint32(HNPRQ)}}
}

func (p *USB_OTG_Global_Periph) HSHNPEN() GOTGCTL_Mask {
	return GOTGCTL_Mask{mmio.UM32{&p.GOTGCTL.U32, uint32(HSHNPEN)}}
}

func (p *USB_OTG_Global_Periph) DHNPEN() GOTGCTL_Mask {
	return GOTGCTL_Mask{mmio.UM32{&p.GOTGCTL.U32, uint32(DHNPEN)}}
}

func (p *USB_OTG_Global_Periph) EHEN() GOTGCTL_Mask {
	return GOTGCTL_Mask{mmio.UM32{&p.GOTGCTL.U32, uint32(EHEN)}}
}

func (p *USB_OTG_Global_Periph) CIDSTS() GOTGCTL_Mask {
	return GOTGCTL_Mask{mmio.UM32{&p.GOTGCTL.U32, uint32(CIDSTS)}}
}

func (p *USB_OTG_Global_Periph) DBCT() GOTGCTL_Mask {
	return GOTGCTL_Mask{mmio.UM32{&p.GOTGCTL.U32, uint32(DBCT)}}
}

func (p *USB_OTG_Global_Periph) ASVLD() GOTGCTL_Mask {
	return GOTGCTL_Mask{mmio.UM32{&p.GOTGCTL.U32, uint32(ASVLD)}}
}
...
func (p *USB_OTG_Global_Periph) OTGVER() GOTGCTL_Mask {
	return GOTGCTL_Mask{mmio.UM32{&p.GOTGCTL.U32, uint32(OTGVER)}}
}
...
func (p *USB_OTG_Global_Periph) IDCHNG() GOTGINT_Mask {
	return GOTGINT_Mask{mmio.UM32{&p.GOTGINT.U32, uint32(IDCHNG)}}
}
...
func (p *USB_OTG_Global_Periph) RSTDET() GINTSTS_Mask {
	return GINTSTS_Mask{mmio.UM32{&p.GINTSTS.U32, uint32(RSTDET)}}
}
...
func (p *USB_OTG_Global_Periph) RSTDEM() GINTMSK_Mask {
	return GINTMSK_Mask{mmio.UM32{&p.GINTMSK.U32, uint32(RSTDEM)}}
}
...
func (p *USB_OTG_Global_Periph) L1RSMOK() GLPMCFG_Mask {
	return GLPMCFG_Mask{mmio.UM32{&p.GLPMCFG.U32, uint32(L1RSMOK)}}
}
...
func (p *USB_OTG_Global_Periph) ADPMEN() GPWRDN_Mask {
	return GPWRDN_Mask{mmio.UM32{&p.GPWRDN.U32, uint32(ADPMEN)}}
}

func (p *USB_OTG_Global_Periph) ADPIF() GPWRDN_Mask {
	return GPWRDN_Mask{mmio.UM32{&p.GPWRDN.U32, uint32(ADPIF)}}
}
