...
const (
	...
	DSPD_0      DCFG_Bits = 0x01 << 0  //  Bit 0.
	DSPD_1      DCFG_Bits = 0x02 << 0  //  Bit 1.
	NZLSOHSK    DCFG_Bits = 0x01 << 2  //+ Nonzero-length status OUT handshake.
	DAD         DCFG_Bits = 0x7F << 4  //+ Device address.
	DAD_0       DCFG_Bits = 0x01 << 4  //  Bit 0.
	DAD_1       DCFG_Bits = 0x02 << 4  //  Bit 1.
	DAD_2       DCFG_Bits = 0x04 << 4  //  Bit 2.
	DAD_3       DCFG_Bits = 0x08 << 4  //  Bit 3.
	DAD_4       DCFG_Bits = 0x10 << 4  //  Bit 4.
	DAD_5       DCFG_Bits = 0x20 << 4  //  Bit 5.
	DAD_6       DCFG_Bits = 0x40 << 4  //  Bit 6.
	PFIVL       DCFG_Bits = 0x03 << 11 //+ Periodic (micro)frame interval.
	PFIVL_0     DCFG_Bits = 0x01 << 11 //  Bit 0.
	PFIVL_1     DCFG_Bits = 0x02 << 11 //  Bit 1.
	PERSCHIVL   DCFG_Bits = 0x03 << 24 //+ Periodic scheduling interval.
	PERSCHIVL_0 DCFG_Bits = 0x01 << 24 //  Bit 0.
	PERSCHIVL_1 DCFG_Bits = 0x02 << 24 //  Bit 1.
)
...
const (
	...
	TCTL_0   DCTL_Bits = 0x01 << 4  //  Bit 0.
	TCTL_1   DCTL_Bits = 0x02 << 4  //  Bit 1.
	TCTL_2   DCTL_Bits = 0x04 << 4  //  Bit 2.
...
const (
	...
	ENUMSPD_0 DSTS_Bits = 0x01 << 1   //  Bit 0.
	ENUMSPD_1 DSTS_Bits = 0x02 << 1   //  Bit 1.
...
const (
	...
	OTEPSPRM DOEPMSK_Bits = 0x01 << 5 //+ Status Phase Received mask.
...
const (
	...
	TXTHRLEN_0  DTHRCTL_Bits = 0x01 << 2   //  Bit 0.
	TXTHRLEN_1  DTHRCTL_Bits = 0x02 << 2   //  Bit 1.
	TXTHRLEN_2  DTHRCTL_Bits = 0x04 << 2   //  Bit 2.
	TXTHRLEN_3  DTHRCTL_Bits = 0x08 << 2   //  Bit 3.
	TXTHRLEN_4  DTHRCTL_Bits = 0x10 << 2   //  Bit 4.
	TXTHRLEN_5  DTHRCTL_Bits = 0x20 << 2   //  Bit 5.
	TXTHRLEN_6  DTHRCTL_Bits = 0x40 << 2   //  Bit 6.
	TXTHRLEN_7  DTHRCTL_Bits = 0x80 << 2   //  Bit 7.
	TXTHRLEN_8  DTHRCTL_Bits = 0x100 << 2  //  Bit 8.
	RXTHREN     DTHRCTL_Bits = 0x01 << 16  //+ Receive threshold enable.
	RXTHRLEN    DTHRCTL_Bits = 0x1FF << 17 //+ Receive threshold length.
	RXTHRLEN_0  DTHRCTL_Bits = 0x01 << 17  //  Bit 0.
	RXTHRLEN_1  DTHRCTL_Bits = 0x02 << 17  //  Bit 1.
	RXTHRLEN_2  DTHRCTL_Bits = 0x04 << 17  //  Bit 2.
	RXTHRLEN_3  DTHRCTL_Bits = 0x08 << 17  //  Bit 3.
	RXTHRLEN_4  DTHRCTL_Bits = 0x10 << 17  //  Bit 4.
	RXTHRLEN_5  DTHRCTL_Bits = 0x20 << 17  //  Bit 5.
	RXTHRLEN_6  DTHRCTL_Bits = 0x40 << 17  //  Bit 6.
	RXTHRLEN_7  DTHRCTL_Bits = 0x80 << 17  //  Bit 7.
	RXTHRLEN_8  DTHRCTL_Bits = 0x100 << 17 //  Bit 8.
