...
func (p *LPTIM_Periph) CMPM() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(CMPM)}}
}

func (p *LPTIM_Periph) ARRM() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(ARRM)}}
}

func (p *LPTIM_Periph) EXTTRIG() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(EXTTRIG)}}
}

func (p *LPTIM_Periph) CMPOK() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(CMPOK)}}
}

func (p *LPTIM_Periph) ARROK() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(ARROK)}}
}

func (p *LPTIM_Periph) UP() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(UP)}}
}

func (p *LPTIM_Periph) DOWN() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(DOWN)}}
}
...
func (p *LPTIM_Periph) CMPMCF() ICR_Mask {
	return ICR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(CMPMCF)}}
}

func (p *LPTIM_Periph) ARRMCF() ICR_Mask {
	return ICR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(ARRMCF)}}
}

func (p *LPTIM_Periph) EXTTRIGCF() ICR_Mask {
	return ICR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(EXTTRIGCF)}}
}

func (p *LPTIM_Periph) CMPOKCF() ICR_Mask {
	return ICR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(CMPOKCF)}}
}

func (p *LPTIM_Periph) ARROKCF() ICR_Mask {
	return ICR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(ARROKCF)}}
}

func (p *LPTIM_Periph) UPCF() ICR_Mask {
	return ICR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(UPCF)}}
}

func (p *LPTIM_Periph) DOWNCF() ICR_Mask {
	return ICR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(DOWNCF)}}
}
...
func (p *LPTIM_Periph) CMPMIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(CMPMIE)}}
}

func (p *LPTIM_Periph) ARRMIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(ARRMIE)}}
}

func (p *LPTIM_Periph) EXTTRIGIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(EXTTRIGIE)}}
}

func (p *LPTIM_Periph) CMPOKIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(CMPOKIE)}}
}

func (p *LPTIM_Periph) ARROKIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(ARROKIE)}}
}

func (p *LPTIM_Periph) UPIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(UPIE)}}
}

func (p *LPTIM_Periph) DOWNIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(DOWNIE)}}
}
...
func (p *LPTIM_Periph) CKSEL() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(CKSEL)}}
}

func (p *LPTIM_Periph) CKPOL() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(CKPOL)}}
}

func (p *LPTIM_Periph) CKFLT() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(CKFLT)}}
}

func (p *LPTIM_Periph) TRGFLT() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(TRGFLT)}}
}

func (p *LPTIM_Periph) PRESC() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(PRESC)}}
}

func (p *LPTIM_Periph) TRIGSEL() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(TRIGSEL)}}
}

func (p *LPTIM_Periph) TRIGEN() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(TRIGEN)}}
}

func (p *LPTIM_Periph) TIMOUT() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(TIMOUT)}}
}

func (p *LPTIM_Periph) WAVE() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(WAVE)}}
}

func (p *LPTIM_Periph) WAVPOL() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(WAVPOL)}}
}

func (p *LPTIM_Periph) PRELOAD() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(PRELOAD)}}
}

func (p *LPTIM_Periph) COUNTMODE() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(COUNTMODE)}}
}

func (p *LPTIM_Periph) ENC() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(ENC)}}
}
...
func (p *LPTIM_Periph) ENABLE() CR_Mask {
	return CR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(ENABLE)}}
}

func (p *LPTIM_Periph) SNGSTRT() CR_Mask {
	return CR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(SNGSTRT)}}
}

func (p *LPTIM_Periph) CNTSTRT() CR_Mask {
	return CR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(CNTSTRT)}}
}
