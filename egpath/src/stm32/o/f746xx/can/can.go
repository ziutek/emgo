...
const (
	...
	TS1_0 BTR_Bits = 0x01 << 16 //  Bit 0.
	TS1_1 BTR_Bits = 0x02 << 16 //  Bit 1.
	TS1_2 BTR_Bits = 0x04 << 16 //  Bit 2.
	TS1_3 BTR_Bits = 0x08 << 16 //  Bit 3.
	TS2   BTR_Bits = 0x07 << 20 //+ Time Segment 2.
	TS2_0 BTR_Bits = 0x01 << 20 //  Bit 0.
	TS2_1 BTR_Bits = 0x02 << 20 //  Bit 1.
	TS2_2 BTR_Bits = 0x04 << 20 //  Bit 2.
	SJW   BTR_Bits = 0x03 << 24 //+ Resynchronization Jump Width.
	SJW_0 BTR_Bits = 0x01 << 24 //  Bit 0.
	SJW_1 BTR_Bits = 0x02 << 24 //  Bit 1.
...
const (
	...
	CAN2SB FMR_Bits = 0x3F << 8 //+ CAN2 start bank.
)
