...
const (
	...
	EDATAST_4  BWTR = 0x10 << 8  //  Bit 4.
	EDATAST_5  BWTR = 0x20 << 8  //  Bit 5.
	EDATAST_6  BWTR = 0x40 << 8  //  Bit 6.
	EDATAST_7  BWTR = 0x80 << 8  //  Bit 7.
	EBUSTURN   BWTR = 0x0F << 16 //+ BUSTURN[3:0] bits (Bus turnaround phase duration).
	EBUSTURN_0 BWTR = 0x01 << 16 //  Bit 0.
	EBUSTURN_1 BWTR = 0x02 << 16 //  Bit 1.
	EBUSTURN_2 BWTR = 0x04 << 16 //  Bit 2.
	EBUSTURN_3 BWTR = 0x08 << 16 //  Bit 3.
