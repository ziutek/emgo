...
const (
	...
	CPSIZE    BCR_Bits = 0x07 << 16 //+ CRAM page size.
	CPSIZE_0  BCR_Bits = 0x01 << 16 //  Bit 0.
	CPSIZE_1  BCR_Bits = 0x02 << 16 //  Bit 1.
	CPSIZE_2  BCR_Bits = 0x04 << 16 //  Bit 2.
	CBURSTRW  BCR_Bits = 0x01 << 19 //+ Write burst enable.
	CCLKEN    BCR_Bits = 0x01 << 20 //+ Continous clock enable.
	WFDIS     BCR_Bits = 0x01 << 21 //+ Write FIFO Disable.
)
