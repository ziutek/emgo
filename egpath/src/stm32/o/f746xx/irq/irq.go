...
const (
	...
	SAI2               nvic.IRQ = 91 // SAI2 global Interrupt.
	QUADSPI            nvic.IRQ = 92 // Quad SPI global interrupt.
	LPTIM1             nvic.IRQ = 93 // LP TIM1 interrupt.
	CEC                nvic.IRQ = 94 // HDMI-CEC global Interrupt.
	I2C4_EV            nvic.IRQ = 95 // I2C4 Event Interrupt.
	I2C4_ER            nvic.IRQ = 96 // I2C4 Error Interrupt.
	SPDIF_RX           nvic.IRQ = 97 // SPDIF-RX global Interrupt.
)
