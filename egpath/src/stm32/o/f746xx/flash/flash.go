...
const (
	...
	ARTEN        ACR_Bits = 0x01 << 9  //+
	ARTRST       ACR_Bits = 0x01 << 11 //+
)
...
const (
	...
	BOR_LEV_1  OPTCR_Bits = 0x02 << 2
	WWDG_SW    OPTCR_Bits = 0x01 << 4 //+
	IWDG_SW    OPTCR_Bits = 0x01 << 5 //+
	...
	IWDG_STDBY OPTCR_Bits = 0x01 << 30 //+
	IWDG_STOP  OPTCR_Bits = 0x01 << 31 //+
)
