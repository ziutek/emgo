...
func (r *SSCR) AtomicStoreBits(mask, b SSCR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *SSCR) AtomicSetBits(mask SSCR_Bits)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *SSCR) AtomicClearBits(mask SSCR_Bits)    { r.U32.AtomicClearBits(uint32(mask)) }
...
func (p *LTDC_Periph) VSH() SSCR_Mask {
	return SSCR_Mask{mmio.UM32{&p.SSCR.U32, uint32(VSH)}}
}

func (p *LTDC_Periph) HSW() SSCR_Mask {
	return SSCR_Mask{mmio.UM32{&p.SSCR.U32, uint32(HSW)}}
}
...
func (r *BPCR) AtomicStoreBits(mask, b BPCR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *BPCR) AtomicSetBits(mask BPCR_Bits)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *BPCR) AtomicClearBits(mask BPCR_Bits)    { r.U32.AtomicClearBits(uint32(mask)) }
...
func (p *LTDC_Periph) AVBP() BPCR_Mask {
	return BPCR_Mask{mmio.UM32{&p.BPCR.U32, uint32(AVBP)}}
}

func (p *LTDC_Periph) AHBP() BPCR_Mask {
	return BPCR_Mask{mmio.UM32{&p.BPCR.U32, uint32(AHBP)}}
}
...
func (r *AWCR) AtomicStoreBits(mask, b AWCR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *AWCR) AtomicSetBits(mask AWCR_Bits)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *AWCR) AtomicClearBits(mask AWCR_Bits)    { r.U32.AtomicClearBits(uint32(mask)) }
...
func (p *LTDC_Periph) AAH() AWCR_Mask {
	return AWCR_Mask{mmio.UM32{&p.AWCR.U32, uint32(AAH)}}
}

func (p *LTDC_Periph) AAW() AWCR_Mask {
	return AWCR_Mask{mmio.UM32{&p.AWCR.U32, uint32(AAW)}}
}
...
func (r *TWCR) AtomicStoreBits(mask, b TWCR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *TWCR) AtomicSetBits(mask TWCR_Bits)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *TWCR) AtomicClearBits(mask TWCR_Bits)    { r.U32.AtomicClearBits(uint32(mask)) }
...
func (p *LTDC_Periph) TOTALH() TWCR_Mask {
	return TWCR_Mask{mmio.UM32{&p.TWCR.U32, uint32(TOTALH)}}
}

func (p *LTDC_Periph) TOTALW() TWCR_Mask {
	return TWCR_Mask{mmio.UM32{&p.TWCR.U32, uint32(TOTALW)}}
}
...
func (p *LTDC_Periph) LTDCEN() GCR_Mask {
	return GCR_Mask{mmio.UM32{&p.GCR.U32, uint32(LTDCEN)}}
}

func (p *LTDC_Periph) DBW() GCR_Mask {
	return GCR_Mask{mmio.UM32{&p.GCR.U32, uint32(DBW)}}
}

func (p *LTDC_Periph) DGW() GCR_Mask {
	return GCR_Mask{mmio.UM32{&p.GCR.U32, uint32(DGW)}}
}

func (p *LTDC_Periph) DRW() GCR_Mask {
	return GCR_Mask{mmio.UM32{&p.GCR.U32, uint32(DRW)}}
}

func (p *LTDC_Periph) DEN() GCR_Mask {
	return GCR_Mask{mmio.UM32{&p.GCR.U32, uint32(DEN)}}
}

func (p *LTDC_Periph) PCPOL() GCR_Mask {
	return GCR_Mask{mmio.UM32{&p.GCR.U32, uint32(PCPOL)}}
}

func (p *LTDC_Periph) DEPOL() GCR_Mask {
	return GCR_Mask{mmio.UM32{&p.GCR.U32, uint32(DEPOL)}}
}

func (p *LTDC_Periph) VSPOL() GCR_Mask {
	return GCR_Mask{mmio.UM32{&p.GCR.U32, uint32(VSPOL)}}
}

func (p *LTDC_Periph) HSPOL() GCR_Mask {
	return GCR_Mask{mmio.UM32{&p.GCR.U32, uint32(HSPOL)}}
}
...
func (r *SRCR) AtomicStoreBits(mask, b SRCR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *SRCR) AtomicSetBits(mask SRCR_Bits)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *SRCR) AtomicClearBits(mask SRCR_Bits)    { r.U32.AtomicClearBits(uint32(mask)) }
...
func (p *LTDC_Periph) IMR() SRCR_Mask {
	return SRCR_Mask{mmio.UM32{&p.SRCR.U32, uint32(IMR)}}
}

func (p *LTDC_Periph) VBR() SRCR_Mask {
	return SRCR_Mask{mmio.UM32{&p.SRCR.U32, uint32(VBR)}}
}
...
func (r *BCCR) AtomicStoreBits(mask, b BCCR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *BCCR) AtomicSetBits(mask BCCR_Bits)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *BCCR) AtomicClearBits(mask BCCR_Bits)    { r.U32.AtomicClearBits(uint32(mask)) }
...
func (p *LTDC_Periph) BCBLUE() BCCR_Mask {
	return BCCR_Mask{mmio.UM32{&p.BCCR.U32, uint32(BCBLUE)}}
}

func (p *LTDC_Periph) BCGREEN() BCCR_Mask {
	return BCCR_Mask{mmio.UM32{&p.BCCR.U32, uint32(BCGREEN)}}
}

func (p *LTDC_Periph) BCRED() BCCR_Mask {
	return BCCR_Mask{mmio.UM32{&p.BCCR.U32, uint32(BCRED)}}
}
...
func (p *LTDC_Periph) LIE() IER_Mask {
	return IER_Mask{mmio.UM32{&p.IER.U32, uint32(LIE)}}
}

func (p *LTDC_Periph) FUIE() IER_Mask {
	return IER_Mask{mmio.UM32{&p.IER.U32, uint32(FUIE)}}
}

func (p *LTDC_Periph) TERRIE() IER_Mask {
	return IER_Mask{mmio.UM32{&p.IER.U32, uint32(TERRIE)}}
}

func (p *LTDC_Periph) RRIE() IER_Mask {
	return IER_Mask{mmio.UM32{&p.IER.U32, uint32(RRIE)}}
}
...
func (p *LTDC_Periph) LIF() ISR_Mask {
	return ISR_Mask{mmio.UM32{&p.ISR.U32, uint32(LIF)}}
}

func (p *LTDC_Periph) FUIF() ISR_Mask {
	return ISR_Mask{mmio.UM32{&p.ISR.U32, uint32(FUIF)}}
}

func (p *LTDC_Periph) TERRIF() ISR_Mask {
	return ISR_Mask{mmio.UM32{&p.ISR.U32, uint32(TERRIF)}}
}

func (p *LTDC_Periph) RRIF() ISR_Mask {
	return ISR_Mask{mmio.UM32{&p.ISR.U32, uint32(RRIF)}}
}
...
func (p *LTDC_Periph) CLIF() ICR_Mask {
	return ICR_Mask{mmio.UM32{&p.ICR.U32, uint32(CLIF)}}
}

func (p *LTDC_Periph) CFUIF() ICR_Mask {
	return ICR_Mask{mmio.UM32{&p.ICR.U32, uint32(CFUIF)}}
}

func (p *LTDC_Periph) CTERRIF() ICR_Mask {
	return ICR_Mask{mmio.UM32{&p.ICR.U32, uint32(CTERRIF)}}
}

func (p *LTDC_Periph) CRRIF() ICR_Mask {
	return ICR_Mask{mmio.UM32{&p.ICR.U32, uint32(CRRIF)}}
}
...
func (r *LIPCR) AtomicStoreBits(mask, b LIPCR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *LIPCR) AtomicSetBits(mask LIPCR_Bits)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *LIPCR) AtomicClearBits(mask LIPCR_Bits)    { r.U32.AtomicClearBits(uint32(mask)) }
...
func (p *LTDC_Periph) LIPOS() LIPCR_Mask {
	return LIPCR_Mask{mmio.UM32{&p.LIPCR.U32, uint32(LIPOS)}}
}
...
func (r *CPSR) AtomicStoreBits(mask, b CPSR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *CPSR) AtomicSetBits(mask CPSR_Bits)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *CPSR) AtomicClearBits(mask CPSR_Bits)    { r.U32.AtomicClearBits(uint32(mask)) }
...
func (p *LTDC_Periph) CYPOS() CPSR_Mask {
	return CPSR_Mask{mmio.UM32{&p.CPSR.U32, uint32(CYPOS)}}
}

func (p *LTDC_Periph) CXPOS() CPSR_Mask {
	return CPSR_Mask{mmio.UM32{&p.CPSR.U32, uint32(CXPOS)}}
}
...
func (r *CDSR) AtomicStoreBits(mask, b CDSR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *CDSR) AtomicSetBits(mask CDSR_Bits)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *CDSR) AtomicClearBits(mask CDSR_Bits)    { r.U32.AtomicClearBits(uint32(mask)) }
...
func (p *LTDC_Periph) VDES() CDSR_Mask {
	return CDSR_Mask{mmio.UM32{&p.CDSR.U32, uint32(VDES)}}
}

func (p *LTDC_Periph) HDES() CDSR_Mask {
	return CDSR_Mask{mmio.UM32{&p.CDSR.U32, uint32(HDES)}}
}

func (p *LTDC_Periph) VSYNCS() CDSR_Mask {
	return CDSR_Mask{mmio.UM32{&p.CDSR.U32, uint32(VSYNCS)}}
}

func (p *LTDC_Periph) HSYNCS() CDSR_Mask {
	return CDSR_Mask{mmio.UM32{&p.CDSR.U32, uint32(HSYNCS)}}
}
