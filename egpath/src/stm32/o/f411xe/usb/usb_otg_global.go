...
const (
	...
	BSVLD   GOTGCTL = 0x01 << 19 //+ B-session valid.
)
...
const (
	...
	I2CPADEN   GCCFG = 0x01 << 17 //+ Enable I2C bus connection for the external I2C PHY interface.
	VBUSASEN   GCCFG = 0x01 << 18 //+ Enable the VBUS sensing device.
	VBUSBSEN   GCCFG = 0x01 << 19 //+ Enable the VBUS sensing device.
	SOFOUTEN   GCCFG = 0x01 << 20 //+ SOF output enable.
	NOVBUSSENS GCCFG = 0x01 << 21 //+ VBUS sensing disable option.
)
