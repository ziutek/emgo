...
func (p *ADC_Common_Periph) AWD1() CSR_Mask {
	return CSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(AWD1)}}
}

func (p *ADC_Common_Periph) EOC1() CSR_Mask {
	return CSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(EOC1)}}
}

func (p *ADC_Common_Periph) JEOC1() CSR_Mask {
	return CSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(JEOC1)}}
}

func (p *ADC_Common_Periph) JSTRT1() CSR_Mask {
	return CSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(JSTRT1)}}
}
...
func (p *ADC_Common_Periph) AWD2() CSR_Mask {
	return CSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(AWD2)}}
}

func (p *ADC_Common_Periph) EOC2() CSR_Mask {
	return CSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(EOC2)}}
}

func (p *ADC_Common_Periph) JEOC2() CSR_Mask {
	return CSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(JEOC2)}}
}

func (p *ADC_Common_Periph) JSTRT2() CSR_Mask {
	return CSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(JSTRT2)}}
}
...
func (p *ADC_Common_Periph) AWD3() CSR_Mask {
	return CSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(AWD3)}}
}

func (p *ADC_Common_Periph) EOC3() CSR_Mask {
	return CSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(EOC3)}}
}

func (p *ADC_Common_Periph) JEOC3() CSR_Mask {
	return CSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(JEOC3)}}
}

func (p *ADC_Common_Periph) JSTRT3() CSR_Mask {
	return CSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(JSTRT3)}}
}
...
func (p *ADC_Common_Periph) MULTI() CCR_Mask {
	return CCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(MULTI)}}
}

func (p *ADC_Common_Periph) DELAY() CCR_Mask {
	return CCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(DELAY)}}
}

func (p *ADC_Common_Periph) DDS() CCR_Mask {
	return CCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(DDS)}}
}

func (p *ADC_Common_Periph) DMA() CCR_Mask {
	return CCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(DMA)}}
}

func (p *ADC_Common_Periph) ADCPRE() CCR_Mask {
	return CCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(ADCPRE)}}
}

func (p *ADC_Common_Periph) VBATE() CCR_Mask {
	return CCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(VBATE)}}
}

func (p *ADC_Common_Periph) TSVREFE() CCR_Mask {
	return CCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(TSVREFE)}}
}
...
func (p *ADC_Common_Periph) DATA1() CDR_Mask {
	return CDR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(DATA1)}}
}

func (p *ADC_Common_Periph) DATA2() CDR_Mask {
	return CDR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(DATA2)}}
}
