...
type RRESERVED3 struct{ mmio.U32 }

func (r *RRESERVED3) Bits(mask RESERVED3) RESERVED3 { return RESERVED3(r.U32.Bits(uint32(mask))) }
func (r *RRESERVED3) StoreBits(mask, b RESERVED3)   { r.U32.StoreBits(uint32(mask), uint32(b)) }
func (r *RRESERVED3) SetBits(mask RESERVED3)        { r.U32.SetBits(uint32(mask)) }
func (r *RRESERVED3) ClearBits(mask RESERVED3)      { r.U32.ClearBits(uint32(mask)) }
func (r *RRESERVED3) Load() RESERVED3               { return RESERVED3(r.U32.Load()) }
func (r *RRESERVED3) Store(b RESERVED3)             { r.U32.Store(uint32(b)) }

func (r *RRESERVED3) AtomicStoreBits(mask, b RESERVED3) {
	r.U32.AtomicStoreBits(uint32(mask), uint32(b))
}
func (r *RRESERVED3) AtomicSetBits(mask RESERVED3)   { r.U32.AtomicSetBits(uint32(mask)) }
func (r *RRESERVED3) AtomicClearBits(mask RESERVED3) { r.U32.AtomicClearBits(uint32(mask)) }

type RMRESERVED3 struct{ mmio.UM32 }

func (rm RMRESERVED3) Load() RESERVED3   { return RESERVED3(rm.UM32.Load()) }
func (rm RMRESERVED3) Store(b RESERVED3) { rm.UM32.Store(uint32(b)) }
