...
const (
	...
	TxHalfEmpty Event = 1 << 14 // There are at least 8 empty words in Tx FIFO.
	RxHalfFull  Event = 1 << 15 // There are at least 8 valid words in Rx FIFO.
	TxFull      Event = 1 << 16 // Tx FIFO full (32 valid words).
	RxFull      Event = 1 << 17 // Rx FIFO full (32 valid words).
	TxEmpty     Event = 1 << 18 // Tx FIFO is empty (32 empty words).
	RxEmpty     Event = 1 << 19 // Rx FIFO empty (32 empty words).
