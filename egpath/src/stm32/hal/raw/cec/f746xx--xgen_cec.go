...
func (p *CEC_Periph) CECEN() CR_Mask {
	return CR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(CECEN)}}
}

func (p *CEC_Periph) TXSOM() CR_Mask {
	return CR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(TXSOM)}}
}

func (p *CEC_Periph) TXEOM() CR_Mask {
	return CR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(TXEOM)}}
}
...
func (p *CEC_Periph) SFT() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(SFT)}}
}

func (p *CEC_Periph) RXTOL() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(RXTOL)}}
}

func (p *CEC_Periph) BRESTP() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(BRESTP)}}
}

func (p *CEC_Periph) BREGEN() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(BREGEN)}}
}

func (p *CEC_Periph) LBPEGEN() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(LBPEGEN)}}
}

func (p *CEC_Periph) BRDNOGEN() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(BRDNOGEN)}}
}

func (p *CEC_Periph) SFTOPT() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(SFTOPT)}}
}

func (p *CEC_Periph) OAR() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(OAR)}}
}

func (p *CEC_Periph) LSTN() CFGR_Mask {
	return CFGR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(LSTN)}}
}
...
func (p *CEC_Periph) TXD() TXDR_Mask {
	return TXDR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(TXD)}}
}
...
func (p *CEC_Periph) RXBR() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(RXBR)}}
}

func (p *CEC_Periph) RXEND() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(RXEND)}}
}

func (p *CEC_Periph) RXOVR() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(RXOVR)}}
}

func (p *CEC_Periph) BRE() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(BRE)}}
}

func (p *CEC_Periph) SBPE() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(SBPE)}}
}

func (p *CEC_Periph) LBPE() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(LBPE)}}
}

func (p *CEC_Periph) RXACKE() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(RXACKE)}}
}

func (p *CEC_Periph) ARBLST() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(ARBLST)}}
}

func (p *CEC_Periph) TXBR() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(TXBR)}}
}

func (p *CEC_Periph) TXEND() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(TXEND)}}
}

func (p *CEC_Periph) TXUDR() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(TXUDR)}}
}

func (p *CEC_Periph) TXERR() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(TXERR)}}
}

func (p *CEC_Periph) TXACKE() ISR_Mask {
	return ISR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(TXACKE)}}
}
...
func (p *CEC_Periph) RXBRIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 20)), uint32(RXBRIE)}}
}

func (p *CEC_Periph) RXENDIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 20)), uint32(RXENDIE)}}
}

func (p *CEC_Periph) RXOVRIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 20)), uint32(RXOVRIE)}}
}

func (p *CEC_Periph) BREIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 20)), uint32(BREIE)}}
}

func (p *CEC_Periph) SBPEIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 20)), uint32(SBPEIE)}}
}

func (p *CEC_Periph) LBPEIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 20)), uint32(LBPEIE)}}
}

func (p *CEC_Periph) RXACKEIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 20)), uint32(RXACKEIE)}}
}

func (p *CEC_Periph) ARBLSTIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 20)), uint32(ARBLSTIE)}}
}

func (p *CEC_Periph) TXBRIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 20)), uint32(TXBRIE)}}
}

func (p *CEC_Periph) TXENDIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 20)), uint32(TXENDIE)}}
}

func (p *CEC_Periph) TXUDRIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 20)), uint32(TXUDRIE)}}
}

func (p *CEC_Periph) TXERRIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 20)), uint32(TXERRIE)}}
}

func (p *CEC_Periph) TXACKEIE() IER_Mask {
	return IER_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 20)), uint32(TXACKEIE)}}
}
