...
func (p *LCD_Periph) LCDEN() CR_Mask {
	return CR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(LCDEN)}}
}

func (p *LCD_Periph) VSEL() CR_Mask {
	return CR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(VSEL)}}
}

func (p *LCD_Periph) DUTY() CR_Mask {
	return CR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(DUTY)}}
}

func (p *LCD_Periph) BIAS() CR_Mask {
	return CR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(BIAS)}}
}

func (p *LCD_Periph) MUX_SEG() CR_Mask {
	return CR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(MUX_SEG)}}
}
...
func (p *LCD_Periph) HD() FCR_Mask {
	return FCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(HD)}}
}

func (p *LCD_Periph) SOFIE() FCR_Mask {
	return FCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(SOFIE)}}
}

func (p *LCD_Periph) UDDIE() FCR_Mask {
	return FCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(UDDIE)}}
}

func (p *LCD_Periph) PON() FCR_Mask {
	return FCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(PON)}}
}

func (p *LCD_Periph) DEAD() FCR_Mask {
	return FCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(DEAD)}}
}

func (p *LCD_Periph) CC() FCR_Mask {
	return FCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(CC)}}
}

func (p *LCD_Periph) BLINKF() FCR_Mask {
	return FCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(BLINKF)}}
}

func (p *LCD_Periph) BLINK() FCR_Mask {
	return FCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(BLINK)}}
}

func (p *LCD_Periph) DIV() FCR_Mask {
	return FCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(DIV)}}
}

func (p *LCD_Periph) PS() FCR_Mask {
	return FCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(PS)}}
}
...
func (p *LCD_Periph) ENS() SR_Mask {
	return SR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(ENS)}}
}

func (p *LCD_Periph) SOF() SR_Mask {
	return SR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(SOF)}}
}
...
func (p *LCD_Periph) UDD() SR_Mask {
	return SR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(UDD)}}
}

func (p *LCD_Periph) RDY() SR_Mask {
	return SR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(RDY)}}
}

func (p *LCD_Periph) FCRSR() SR_Mask {
	return SR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(FCRSR)}}
}
...
func (p *LCD_Periph) SOFC() CLR_Mask {
	return CLR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(SOFC)}}
}

func (p *LCD_Periph) UDDC() CLR_Mask {
	return CLR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(UDDC)}}
}
...
func (p *LCD_Periph) SEGMENT_DATA(n int) RAM_Mask {
	return RAM_Mask{mmio.UM32{&(*[16]mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 20))[n], uint32(SEGMENT_DATA)}}
}
