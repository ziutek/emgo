...
func (p *DCMI_Periph) BSM() CR_Mask {
	return CR_Mask{mmio.UM32{&p.CR.U32, uint32(BSM)}}
}

func (p *DCMI_Periph) OEBS() CR_Mask {
	return CR_Mask{mmio.UM32{&p.CR.U32, uint32(OEBS)}}
}

func (p *DCMI_Periph) LSM() CR_Mask {
	return CR_Mask{mmio.UM32{&p.CR.U32, uint32(LSM)}}
}

func (p *DCMI_Periph) OELS() CR_Mask {
	return CR_Mask{mmio.UM32{&p.CR.U32, uint32(OELS)}}
}
...
func (r *ESCR) AtomicStoreBits(mask, b ESCR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
...
func (r *ESUR) AtomicStoreBits(mask, b ESUR_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
...
func (r *CWSTRTR) AtomicStoreBits(mask, b CWSTRTR_Bits) {
...
func (r *CWSIZER) AtomicStoreBits(mask, b CWSIZER_Bits) {
	r.U32.AtomicStoreBits(uint32(mask), uint32(b))
}
