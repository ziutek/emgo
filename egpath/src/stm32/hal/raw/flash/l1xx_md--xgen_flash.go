...
func (p *FLASH_Periph) PRFTEN() ACR_Mask {
	return ACR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(PRFTEN)}}
}

func (p *FLASH_Periph) ACC64() ACR_Mask {
	return ACR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(ACC64)}}
}

func (p *FLASH_Periph) SLEEP_PD() ACR_Mask {
	return ACR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(SLEEP_PD)}}
}

func (p *FLASH_Periph) RUN_PD() ACR_Mask {
	return ACR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(RUN_PD)}}
}
...
func (p *FLASH_Periph) PELOCK() PECR_Mask {
	return PECR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(PELOCK)}}
}

func (p *FLASH_Periph) PRGLOCK() PECR_Mask {
	return PECR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(PRGLOCK)}}
}

func (p *FLASH_Periph) OPTLOCK() PECR_Mask {
	return PECR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(OPTLOCK)}}
}

func (p *FLASH_Periph) PROG() PECR_Mask {
	return PECR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(PROG)}}
}

func (p *FLASH_Periph) DATA() PECR_Mask {
	return PECR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(DATA)}}
}

func (p *FLASH_Periph) FTDW() PECR_Mask {
	return PECR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(FTDW)}}
}

func (p *FLASH_Periph) ERASE() PECR_Mask {
	return PECR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(ERASE)}}
}

func (p *FLASH_Periph) FPRG() PECR_Mask {
	return PECR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(FPRG)}}
}

func (p *FLASH_Periph) PARALLBANK() PECR_Mask {
	return PECR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(PARALLBANK)}}
}

func (p *FLASH_Periph) EOPIE() PECR_Mask {
	return PECR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(EOPIE)}}
}

func (p *FLASH_Periph) ERRIE() PECR_Mask {
	return PECR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(ERRIE)}}
}

func (p *FLASH_Periph) OBL_LAUNCH() PECR_Mask {
	return PECR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(OBL_LAUNCH)}}
}
...
func (p *FLASH_Periph) BSY() SR_Mask {
	return SR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 24)), uint32(BSY)}}
}

func (p *FLASH_Periph) EOP() SR_Mask {
	return SR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 24)), uint32(EOP)}}
}

func (p *FLASH_Periph) ENHV() SR_Mask {
	return SR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 24)), uint32(ENHV)}}
}

func (p *FLASH_Periph) READY() SR_Mask {
	return SR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 24)), uint32(READY)}}
}

func (p *FLASH_Periph) WRPERR() SR_Mask {
	return SR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 24)), uint32(WRPERR)}}
}

func (p *FLASH_Periph) PGAERR() SR_Mask {
	return SR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 24)), uint32(PGAERR)}}
}

func (p *FLASH_Periph) SIZERR() SR_Mask {
	return SR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 24)), uint32(SIZERR)}}
}

func (p *FLASH_Periph) OPTVERR() SR_Mask {
	return SR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 24)), uint32(OPTVERR)}}
}

func (p *FLASH_Periph) OPTVERRUSR() SR_Mask {
	return SR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 24)), uint32(OPTVERRUSR)}}
}

func (p *FLASH_Periph) RDERR() SR_Mask {
	return SR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 24)), uint32(RDERR)}}
}
...
func (p *FLASH_Periph) SPRMOD() OBR_Mask {
	return OBR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 28)), uint32(SPRMOD)}}
}

func (p *FLASH_Periph) BOR_LEV() OBR_Mask {
	return OBR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 28)), uint32(BOR_LEV)}}
}

func (p *FLASH_Periph) IWDG_SW() OBR_Mask {
	return OBR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 28)), uint32(IWDG_SW)}}
}

func (p *FLASH_Periph) nRST_STOP() OBR_Mask {
	return OBR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 28)), uint32(nRST_STOP)}}
}

func (p *FLASH_Periph) nRST_STDBY() OBR_Mask {
	return OBR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 28)), uint32(nRST_STDBY)}}
}

func (p *FLASH_Periph) BFB2() OBR_Mask {
	return OBR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 28)), uint32(BFB2)}}
}
