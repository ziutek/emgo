...
const (
	LATENCY ACR_Bits = 0x01 << 0 //+ LATENCY bit (Latency).
...
const (
	...
	OBL_LAUNCH CR_Bits = 0x01 << 13 //+ Option Bytes Loader Launch.
)
...
const (
	...
	VDDA_MONITOR     OBR_Bits = 0x20 << 8  //  VDDA power supply supervisor.
	RAM_PARITY_CHECK OBR_Bits = 0x40 << 8  //  RAM parity check.
