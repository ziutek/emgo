...
func (p *TIM_Periph) TI4_RMP() OR_Mask {
	return OR_Mask{mmio.UM16{(*mmio.U16)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 80)), uint16(TI4_RMP)}}
}

func (p *TIM_Periph) ITR1_RMP() OR_Mask {
	return OR_Mask{mmio.UM16{(*mmio.U16)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 80)), uint16(ITR1_RMP)}}
}
