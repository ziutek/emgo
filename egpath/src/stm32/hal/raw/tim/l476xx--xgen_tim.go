...
func (mask OR1) J(v int) OR1 {
	return OR1(bits.MakeField32(v, uint32(mask)))
}

type ROR1 struct{ mmio.U32 }

func (r *ROR1) Bits(mask OR1) OR1     { return OR1(r.U32.Bits(uint32(mask))) }
...
func (r *ROR1) AtomicStoreBits(mask, b OR1) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *ROR1) AtomicSetBits(mask OR1)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *ROR1) AtomicClearBits(mask OR1)    { r.U32.AtomicClearBits(uint32(mask)) }
...
func (mask CCMR3) J(v int) CCMR3 {
	return CCMR3(bits.MakeField32(v, uint32(mask)))
}
...
func (mask CCR5) J(v int) CCR5 {
	return CCR5(bits.MakeField32(v, uint32(mask)))
}
...
func (mask CCR6) J(v int) CCR6 {
	return CCR6(bits.MakeField32(v, uint32(mask)))
}
...
func (mask OR2) J(v int) OR2 {
	return OR2(bits.MakeField32(v, uint32(mask)))
}

type ROR2 struct{ mmio.U32 }

func (r *ROR2) Bits(mask OR2) OR2     { return OR2(r.U32.Bits(uint32(mask))) }
...
func (r *ROR2) AtomicStoreBits(mask, b OR2) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *ROR2) AtomicSetBits(mask OR2)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *ROR2) AtomicClearBits(mask OR2)    { r.U32.AtomicClearBits(uint32(mask)) }
...
func (mask OR3) J(v int) OR3 {
	return OR3(bits.MakeField32(v, uint32(mask)))
}

type ROR3 struct{ mmio.U32 }

func (r *ROR3) Bits(mask OR3) OR3     { return OR3(r.U32.Bits(uint32(mask))) }
...
func (r *ROR3) AtomicStoreBits(mask, b OR3) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
func (r *ROR3) AtomicSetBits(mask OR3)      { r.U32.AtomicSetBits(uint32(mask)) }
func (r *ROR3) AtomicClearBits(mask OR3)    { r.U32.AtomicClearBits(uint32(mask)) }
