...
func (r *CSR1) AtomicStoreBits(mask, b CSR1_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
...
func (r *CSR2) AtomicStoreBits(mask, b CSR2_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
