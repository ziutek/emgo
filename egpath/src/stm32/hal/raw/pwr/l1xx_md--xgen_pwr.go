...
func (p *PWR_Periph) ULP() CR_Mask {
	return CR_Mask{mmio.UM32{&p.CR.U32, uint32(ULP)}}
}

func (p *PWR_Periph) FWU() CR_Mask {
	return CR_Mask{mmio.UM32{&p.CR.U32, uint32(FWU)}}
}
...
func (p *PWR_Periph) LPRUN() CR_Mask {
	return CR_Mask{mmio.UM32{&p.CR.U32, uint32(LPRUN)}}
}
...
func (p *PWR_Periph) VREFINTRDYF() CSR_Mask {
	return CSR_Mask{mmio.UM32{&p.CSR.U32, uint32(VREFINTRDYF)}}
}

func (p *PWR_Periph) VOSF() CSR_Mask {
	return CSR_Mask{mmio.UM32{&p.CSR.U32, uint32(VOSF)}}
}

func (p *PWR_Periph) REGLPF() CSR_Mask {
	return CSR_Mask{mmio.UM32{&p.CSR.U32, uint32(REGLPF)}}
}

func (p *PWR_Periph) EWUP1() CSR_Mask {
	return CSR_Mask{mmio.UM32{&p.CSR.U32, uint32(EWUP1)}}
}

func (p *PWR_Periph) EWUP2() CSR_Mask {
	return CSR_Mask{mmio.UM32{&p.CSR.U32, uint32(EWUP2)}}
}

func (p *PWR_Periph) EWUP3() CSR_Mask {
	return CSR_Mask{mmio.UM32{&p.CSR.U32, uint32(EWUP3)}}
}
