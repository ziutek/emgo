...
func (r *IDCODE) AtomicStoreBits(mask, b IDCODE_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
...
func (r *APB1FZ) AtomicStoreBits(mask, b APB1FZ_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
...
func (p *DBGMCU_Periph) DBG_TIM2_STOP() APB1FZ_Mask {
	return APB1FZ_Mask{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_TIM2_STOP)}}
}

func (p *DBGMCU_Periph) DBG_TIM3_STOP() APB1FZ_Mask {
	return APB1FZ_Mask{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_TIM3_STOP)}}
}

func (p *DBGMCU_Periph) DBG_TIM4_STOP() APB1FZ_Mask {
	return APB1FZ_Mask{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_TIM4_STOP)}}
}

func (p *DBGMCU_Periph) DBG_TIM5_STOP() APB1FZ_Mask {
	return APB1FZ_Mask{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_TIM5_STOP)}}
}

func (p *DBGMCU_Periph) DBG_TIM6_STOP() APB1FZ_Mask {
	return APB1FZ_Mask{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_TIM6_STOP)}}
}

func (p *DBGMCU_Periph) DBG_TIM7_STOP() APB1FZ_Mask {
	return APB1FZ_Mask{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_TIM7_STOP)}}
}

func (p *DBGMCU_Periph) DBG_RTC_STOP() APB1FZ_Mask {
	return APB1FZ_Mask{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_RTC_STOP)}}
}

func (p *DBGMCU_Periph) DBG_WWDG_STOP() APB1FZ_Mask {
	return APB1FZ_Mask{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_WWDG_STOP)}}
}

func (p *DBGMCU_Periph) DBG_IWDG_STOP() APB1FZ_Mask {
	return APB1FZ_Mask{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_IWDG_STOP)}}
}

func (p *DBGMCU_Periph) DBG_I2C1_SMBUS_TIMEOUT() APB1FZ_Mask {
	return APB1FZ_Mask{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_I2C1_SMBUS_TIMEOUT)}}
}

func (p *DBGMCU_Periph) DBG_I2C2_SMBUS_TIMEOUT() APB1FZ_Mask {
	return APB1FZ_Mask{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_I2C2_SMBUS_TIMEOUT)}}
}
...
func (r *APB2FZ) AtomicStoreBits(mask, b APB2FZ_Bits) { r.U32.AtomicStoreBits(uint32(mask), uint32(b)) }
...
func (p *DBGMCU_Periph) DBG_TIM9_STOP() APB2FZ_Mask {
	return APB2FZ_Mask{mmio.UM32{&p.APB2FZ.U32, uint32(DBG_TIM9_STOP)}}
}

func (p *DBGMCU_Periph) DBG_TIM10_STOP() APB2FZ_Mask {
	return APB2FZ_Mask{mmio.UM32{&p.APB2FZ.U32, uint32(DBG_TIM10_STOP)}}
}

func (p *DBGMCU_Periph) DBG_TIM11_STOP() APB2FZ_Mask {
	return APB2FZ_Mask{mmio.UM32{&p.APB2FZ.U32, uint32(DBG_TIM11_STOP)}}
}
