...
func (p *DBGMCU_Periph) DBG_TIM2_STOP() RMAPB1FZ {
	return RMAPB1FZ{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_TIM2_STOP)}}
}

func (p *DBGMCU_Periph) DBG_TIM3_STOP() RMAPB1FZ {
	return RMAPB1FZ{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_TIM3_STOP)}}
}

func (p *DBGMCU_Periph) DBG_TIM4_STOP() RMAPB1FZ {
	return RMAPB1FZ{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_TIM4_STOP)}}
}

func (p *DBGMCU_Periph) DBG_TIM5_STOP() RMAPB1FZ {
	return RMAPB1FZ{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_TIM5_STOP)}}
}

func (p *DBGMCU_Periph) DBG_TIM6_STOP() RMAPB1FZ {
	return RMAPB1FZ{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_TIM6_STOP)}}
}

func (p *DBGMCU_Periph) DBG_TIM7_STOP() RMAPB1FZ {
	return RMAPB1FZ{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_TIM7_STOP)}}
}

func (p *DBGMCU_Periph) DBG_RTC_STOP() RMAPB1FZ {
	return RMAPB1FZ{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_RTC_STOP)}}
}

func (p *DBGMCU_Periph) DBG_WWDG_STOP() RMAPB1FZ {
	return RMAPB1FZ{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_WWDG_STOP)}}
}

func (p *DBGMCU_Periph) DBG_IWDG_STOP() RMAPB1FZ {
	return RMAPB1FZ{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_IWDG_STOP)}}
}

func (p *DBGMCU_Periph) DBG_I2C1_SMBUS_TIMEOUT() RMAPB1FZ {
	return RMAPB1FZ{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_I2C1_SMBUS_TIMEOUT)}}
}

func (p *DBGMCU_Periph) DBG_I2C2_SMBUS_TIMEOUT() RMAPB1FZ {
	return RMAPB1FZ{mmio.UM32{&p.APB1FZ.U32, uint32(DBG_I2C2_SMBUS_TIMEOUT)}}
}
...
func (p *DBGMCU_Periph) DBG_TIM9_STOP() RMAPB2FZ {
	return RMAPB2FZ{mmio.UM32{&p.APB2FZ.U32, uint32(DBG_TIM9_STOP)}}
}

func (p *DBGMCU_Periph) DBG_TIM10_STOP() RMAPB2FZ {
	return RMAPB2FZ{mmio.UM32{&p.APB2FZ.U32, uint32(DBG_TIM10_STOP)}}
}

func (p *DBGMCU_Periph) DBG_TIM11_STOP() RMAPB2FZ {
	return RMAPB2FZ{mmio.UM32{&p.APB2FZ.U32, uint32(DBG_TIM11_STOP)}}
}
