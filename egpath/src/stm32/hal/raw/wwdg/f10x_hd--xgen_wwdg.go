...
func (p *WWDG_Periph) T() CR_Mask {
	return CR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(T)}}
}

func (p *WWDG_Periph) WDGA() CR_Mask {
	return CR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(WDGA)}}
}
...
func (p *WWDG_Periph) W() CFR_Mask {
	return CFR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(W)}}
}

func (p *WWDG_Periph) WDGTB() CFR_Mask {
	return CFR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(WDGTB)}}
}

func (p *WWDG_Periph) EWI() CFR_Mask {
	return CFR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(EWI)}}
}
...
func (p *WWDG_Periph) EWIF() SR_Mask {
	return SR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(EWIF)}}
}
