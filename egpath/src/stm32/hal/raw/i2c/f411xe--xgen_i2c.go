...
func (p *I2C_Periph) DNF() FLTR_Mask {
	return FLTR_Mask{mmio.UM16{(*mmio.U16)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 36)), uint16(DNF)}}
}

func (p *I2C_Periph) ANOFF() FLTR_Mask {
	return FLTR_Mask{mmio.UM16{(*mmio.U16)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 36)), uint16(ANOFF)}}
}
