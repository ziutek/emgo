...
const (
	...
	NEGEDGE  CLKCR_Bits = 0x01 << 13 //+ SDMMC_CK dephasing selection bit.
...
const (
	...
	SDIOITC   ICR_Bits = 0x01 << 22 //+ SDMMCIT flag clear bit.
)
...
const (
	...
	SDIOITIE   MASK_Bits = 0x01 << 22 //+ SDMMC Mode Interrupt Received interrupt Enable.
)
