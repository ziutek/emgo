...
const (
	...
	GIF6  ISR = 0x01 << 20 //+ Channel 6 Global interrupt flag.
	TCIF6 ISR = 0x01 << 21 //+ Channel 6 Transfer Complete flag.
	HTIF6 ISR = 0x01 << 22 //+ Channel 6 Half Transfer flag.
	TEIF6 ISR = 0x01 << 23 //+ Channel 6 Transfer Error flag.
	GIF7  ISR = 0x01 << 24 //+ Channel 7 Global interrupt flag.
	TCIF7 ISR = 0x01 << 25 //+ Channel 7 Transfer Complete flag.
	HTIF7 ISR = 0x01 << 26 //+ Channel 7 Half Transfer flag.
	TEIF7 ISR = 0x01 << 27 //+ Channel 7 Transfer Error flag.
)
...
const (
	CGIF1  IFCR = 0x01 << 0  //+ Channel 1 Global interrupt clearr.
	...
	CGIF6  IFCR = 0x01 << 20 //+ Channel 6 Global interrupt clear.
	CTCIF6 IFCR = 0x01 << 21 //+ Channel 6 Transfer Complete clear.
	CHTIF6 IFCR = 0x01 << 22 //+ Channel 6 Half Transfer clear.
	CTEIF6 IFCR = 0x01 << 23 //+ Channel 6 Transfer Error clear.
	CGIF7  IFCR = 0x01 << 24 //+ Channel 7 Global interrupt clear.
	CTCIF7 IFCR = 0x01 << 25 //+ Channel 7 Transfer Complete clear.
	CHTIF7 IFCR = 0x01 << 26 //+ Channel 7 Half Transfer clear.
	CTEIF7 IFCR = 0x01 << 27 //+ Channel 7 Transfer Error clear.
)
