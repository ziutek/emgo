...
func (p *RTC_Periph) PC15MODE() RMTAFCR {
	return RMTAFCR{mmio.UM32{&p.TAFCR.U32, uint32(PC15MODE)}}
}

func (p *RTC_Periph) PC15VALUE() RMTAFCR {
	return RMTAFCR{mmio.UM32{&p.TAFCR.U32, uint32(PC15VALUE)}}
}

func (p *RTC_Periph) PC14MODE() RMTAFCR {
	return RMTAFCR{mmio.UM32{&p.TAFCR.U32, uint32(PC14MODE)}}
}

func (p *RTC_Periph) PC14VALUE() RMTAFCR {
	return RMTAFCR{mmio.UM32{&p.TAFCR.U32, uint32(PC14VALUE)}}
}

func (p *RTC_Periph) PC13MODE() RMTAFCR {
	return RMTAFCR{mmio.UM32{&p.TAFCR.U32, uint32(PC13MODE)}}
}

func (p *RTC_Periph) PC13VALUE() RMTAFCR {
	return RMTAFCR{mmio.UM32{&p.TAFCR.U32, uint32(PC13VALUE)}}
}
...
func (p *RTC_Periph) TAMP3TRG() RMTAFCR {
	return RMTAFCR{mmio.UM32{&p.TAFCR.U32, uint32(TAMP3TRG)}}
}

func (p *RTC_Periph) TAMP3E() RMTAFCR {
	return RMTAFCR{mmio.UM32{&p.TAFCR.U32, uint32(TAMP3E)}}
}
