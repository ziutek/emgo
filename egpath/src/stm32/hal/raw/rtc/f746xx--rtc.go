...
const (
	...
	TAMPPRCH_0   TAMPCR_Bits = 0x01 << 13
	TAMPPRCH_1   TAMPCR_Bits = 0x02 << 13
	TAMPFLT      TAMPCR_Bits = 0x03 << 11 //+
	TAMPFLT_0    TAMPCR_Bits = 0x01 << 11
	TAMPFLT_1    TAMPCR_Bits = 0x02 << 11
	TAMPFREQ     TAMPCR_Bits = 0x07 << 8 //+
	TAMPFREQ_0   TAMPCR_Bits = 0x01 << 8
	TAMPFREQ_1   TAMPCR_Bits = 0x02 << 8
	TAMPFREQ_2   TAMPCR_Bits = 0x04 << 8
...
const (
	TSINSEL   OR_Bits = 0x03 << 1 //+
	TSINSEL_0 OR_Bits = 0x01 << 1
	TSINSEL_1 OR_Bits = 0x02 << 1
	ALARMTYPE OR_Bits = 0x01 << 3 //+
)
