...
//  0x0C 32  CFGR    Configuration register 1.
//  0x10 32  CFGR2   Configuration register 2.
//  0x14 32  SMPR1   Sampling time register 1.
//  0x18 32  SMPR2   Sampling time register 2.
//  0x20 32  TR1     Analog watchdog 1 threshold register.
//  0x24 32  TR2     Analog watchdog 2 threshold register.
//  0x28 32  TR3     Analog watchdog 3 threshold register.
//  0x30 32  SQR1    Group regular sequencer register 1.
//  0x34 32  SQR2    Group regular sequencer register 2.
//  0x38 32  SQR3    Group regular sequencer register 3.
//  0x3C 32  SQR4    Group regular sequencer register 4.
//  0x40 32  DR      Group regular data register.
//  0x4C 32  JSQR    Group injected sequencer register.
//  0x60 32  OFR[4]  Offset registers.
//  0x80 32  JDR[4]  Injected data registers.
//  0xA0 32  AWD2CR  Analog watchdog 1 configuration register.
...
const (
	...
	ADVREGEN CR_Bits = 0x01 << 28 //+ ADC voltage regulator enable.
	DEEPPWD  CR_Bits = 0x01 << 29 //+ ADC deep power down enable.
...
const (
	DMAEN   CFGR_Bits = 0x01 << 0  //+ ADC DMA transfer enable.
	DMACFG  CFGR_Bits = 0x01 << 1  //+ ADC DMA transfer configuration.
	...
	DISCNUM CFGR_Bits = 0x07 << 17 //+ ADC group regular sequencer discontinuous number of ranks.
	JDISCEN CFGR_Bits = 0x01 << 20 //+ ADC group injected sequencer discontinuous mode.
	...
	JQDIS   CFGR_Bits = 0x01 << 31 //+ ADC group injected contexts queue disable.
)
...
const (
	ROVSE CFGR2_Bits = 0x01 << 0  //+ ADC oversampler enable on scope ADC group regular.
	JOVSE CFGR2_Bits = 0x01 << 1  //+ ADC oversampler enable on scope ADC group injected.
	OVSR  CFGR2_Bits = 0x07 << 2  //+ ADC oversampling ratio.
	OVSS  CFGR2_Bits = 0x0F << 5  //+ ADC oversampling shift.
	TROVS CFGR2_Bits = 0x01 << 9  //+ ADC oversampling discontinuous mode (triggered mode) for ADC group regular.
	ROVSM CFGR2_Bits = 0x01 << 10 //+ ADC oversampling mode managing interlaced conversions of ADC group regular and group injected.
)
