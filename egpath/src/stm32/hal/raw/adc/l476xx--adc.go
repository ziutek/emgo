...
const (
	DMAEN   CFGR = 0x01 << 0  //+ ADC DMA transfer enable.
	DMACFG  CFGR = 0x01 << 1  //+ ADC DMA transfer configuration.
...
const (
	...
	OVSR  CFGR2 = 0x07 << 2  //+ ADC oversampling ratio.
	...
	ROVSM CFGR2 = 0x01 << 10 //+ ADC oversampling mode managing interlaced conversions of ADC group regular and group injected.
)
