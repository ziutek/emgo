...
//emgo:const
var LPUART1 = (*USART_Periph)(unsafe.Pointer(uintptr(mmap.LPUART1_BASE)))
...
func (p *USART_Periph) UESM() RMCR1 {
	return RMCR1{mmio.UM32{&p.CR1.U32, uint32(UESM)}}
}
...
func (p *USART_Periph) WUS() RMCR3 {
	return RMCR3{mmio.UM32{&p.CR3.U32, uint32(WUS)}}
}

func (p *USART_Periph) WUFIE() RMCR3 {
	return RMCR3{mmio.UM32{&p.CR3.U32, uint32(WUFIE)}}
}
...
type RRQR struct{ mmio.U16 }

func (r *RRQR) Bits(mask RQR) RQR     { return RQR(r.U16.Bits(uint16(mask))) }
func (r *RRQR) StoreBits(mask, b RQR) { r.U16.StoreBits(uint16(mask), uint16(b)) }
func (r *RRQR) SetBits(mask RQR)      { r.U16.SetBits(uint16(mask)) }
func (r *RRQR) ClearBits(mask RQR)    { r.U16.ClearBits(uint16(mask)) }
func (r *RRQR) Load() RQR             { return RQR(r.U16.Load()) }
func (r *RRQR) Store(b RQR)           { r.U16.Store(uint16(b)) }

type RMRQR struct{ mmio.UM16 }

func (rm RMRQR) Load() RQR   { return RQR(rm.UM16.Load()) }
func (rm RMRQR) Store(b RQR) { rm.UM16.Store(uint16(b)) }

func (p *USART_Periph) ABRRQ() RMRQR {
	return RMRQR{mmio.UM16{&p.RQR.U16, uint16(ABRRQ)}}
}

func (p *USART_Periph) SBKRQ() RMRQR {
	return RMRQR{mmio.UM16{&p.RQR.U16, uint16(SBKRQ)}}
}

func (p *USART_Periph) MMRQ() RMRQR {
	return RMRQR{mmio.UM16{&p.RQR.U16, uint16(MMRQ)}}
}

func (p *USART_Periph) RXFRQ() RMRQR {
	return RMRQR{mmio.UM16{&p.RQR.U16, uint16(RXFRQ)}}
}

func (p *USART_Periph) TXFRQ() RMRQR {
	return RMRQR{mmio.UM16{&p.RQR.U16, uint16(TXFRQ)}}
}
