...
const (
	...
	DMAUDRIE1 CR_Bits = 0x01 << 13 //+ DAC channel 1 DMA underrun interrupt enable  >.
	CEN1      CR_Bits = 0x01 << 14 //+ DAC channel 1 calibration enable >.
	...
	CEN2      CR_Bits = 0x01 << 30 //+ DAC channel2 calibration enable >.
)
...
const (
	...
	CAL_FLAG1 SR_Bits = 0x01 << 14 //+ DAC channel1 calibration offset status.
	BWST1     SR_Bits = 0x01 << 15 //+ DAC channel1 busy writing sample time flag.
	DMAUDR2   SR_Bits = 0x01 << 29 //+ DAC channel2 DMA underrun flag.
	CAL_FLAG2 SR_Bits = 0x01 << 30 //+ DAC channel2 calibration offset status.
	BWST2     SR_Bits = 0x01 << 31 //+ DAC channel2 busy writing sample time flag.
)
...
const (
	OTRIM1 CCR_Bits = 0x1F << 0  //+ DAC channel1 offset trimming value.
	OTRIM2 CCR_Bits = 0x1F << 16 //+ DAC channel2 offset trimming value.
)
...
const (
	MODE1 MCR_Bits = 0x07 << 0  //+ MODE1[2:0] (DAC channel1 mode).
	MODE2 MCR_Bits = 0x07 << 16 //+ MODE2[2:0] (DAC channel2 mode).
)
...
const (
	TSAMPLE1 SHSR1_Bits = 0x3FF << 0 //+ DAC channel1 sample time.
)
...
const (
	TSAMPLE2 SHSR2_Bits = 0x3FF << 0 //+ DAC channel2 sample time.
)
...
const (
	THOLD1 SHHR_Bits = 0x3FF << 0  //+ DAC channel1 hold time.
	THOLD2 SHHR_Bits = 0x3FF << 16 //+ DAC channel2 hold time.
)
...
const (
	TREFRESH1 SHRR_Bits = 0xFF << 0  //+ DAC channel1 refresh time.
	TREFRESH2 SHRR_Bits = 0xFF << 16 //+ DAC channel2 refresh time.
)
