...
const (
	PIF0  PR_Bits = 0x01 << 0  //+ Pending bit 0.
	PIF1  PR_Bits = 0x01 << 1  //+ Pending bit 1.
	PIF2  PR_Bits = 0x01 << 2  //+ Pending bit 2.
	PIF3  PR_Bits = 0x01 << 3  //+ Pending bit 3.
	PIF4  PR_Bits = 0x01 << 4  //+ Pending bit 4.
	PIF5  PR_Bits = 0x01 << 5  //+ Pending bit 5.
	PIF6  PR_Bits = 0x01 << 6  //+ Pending bit 6.
	PIF7  PR_Bits = 0x01 << 7  //+ Pending bit 7.
	PIF8  PR_Bits = 0x01 << 8  //+ Pending bit 8.
	PIF9  PR_Bits = 0x01 << 9  //+ Pending bit 9.
	PIF10 PR_Bits = 0x01 << 10 //+ Pending bit 10.
	PIF11 PR_Bits = 0x01 << 11 //+ Pending bit 11.
	PIF12 PR_Bits = 0x01 << 12 //+ Pending bit 12.
	PIF13 PR_Bits = 0x01 << 13 //+ Pending bit 13.
	PIF14 PR_Bits = 0x01 << 14 //+ Pending bit 14.
	PIF15 PR_Bits = 0x01 << 15 //+ Pending bit 15.
	PIF16 PR_Bits = 0x01 << 16 //+ Pending bit 16.
	PIF17 PR_Bits = 0x01 << 17 //+ Pending bit 17.
	PIF18 PR_Bits = 0x01 << 18 //+ Pending bit 18.
	PIF19 PR_Bits = 0x01 << 19 //+ Pending bit 19.
	PIF20 PR_Bits = 0x01 << 20 //+ Pending bit 20.
	PIF21 PR_Bits = 0x01 << 21 //+ Pending bit 21.
	PIF22 PR_Bits = 0x01 << 22 //+ Pending bit 22.
	PIF23 PR_Bits = 0x01 << 23 //+ Pending bit 23.
)
