...
const (
	...
	IMRALL IMR = 0xFFFFFF << 0 //  Interrupt Mask All.
)
...
const (
	...
	TR23 RTSR = 0x01 << 23 //+ Rising trigger event configuration bit of line 23.
)
...
const (
	...
	TF23 FTSR = 0x01 << 23 //+ Falling trigger event configuration bit of line 23.
)
...
const (
	...
	SWI23 SWIER = 0x01 << 23 //+ Software Interrupt on line 23.
)
...
const (
	...
	PIF23 PR = 0x01 << 23 //+ Pending bit for line 23.
)
