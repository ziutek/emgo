...
// Performance setups MCU for best performance (168MHz, Flash prefetch and cache on).
// It accepts one argument which is freqency of external resonator in MHz.
// Allowed values are multiples of 2 MHz, from 4 MHz to 26 MHz. Use 0 to select
// internal HSI oscilator as clock source.
