...
func rcc(n uint) *mmio.U32 {
	return &(*[34]mmio.U32)(unsafe.Pointer(uintptr(0x40023800)))[n]
}
...
func (m AHB3RSTR_Bits) Set()           { rcc(6).SetBits(uint32(m)) }
func (m AHB3RSTR_Bits) Clear()         { rcc(6).ClearBits(uint32(m)) }
func (m AHB3RSTR_Bits) Load() uint32   { return rcc(6).Bits(uint32(m)) }
func (m AHB3RSTR_Bits) Store(b uint32) { rcc(6).StoreBits(uint32(m), b) }
func (m AHB3RSTR_Bits) LoadVal() int   { return rcc(6).Field(uint32(m)) }
func (m AHB3RSTR_Bits) StoreVal(v int) { rcc(6).SetField(uint32(m), v) }

func AHB3RSTR_Load() AHB3RSTR_Bits   { return AHB3RSTR_Bits(rcc(6).Load()) }
func AHB3RSTR_Store(b AHB3RSTR_Bits) { rcc(6).Store(uint32(b)) }

func (b AHB3RSTR_Bits) Field(mask AHB3RSTR_Bits) int {
	return bits.Field32(uint32(b), uint32(mask))
}
func Make_AHB3RSTR(v int, mask AHB3RSTR_Bits) AHB3RSTR_Bits {
...
func (m AHB3ENR_Bits) Set()           { rcc(14).SetBits(uint32(m)) }
func (m AHB3ENR_Bits) Clear()         { rcc(14).ClearBits(uint32(m)) }
func (m AHB3ENR_Bits) Load() uint32   { return rcc(14).Bits(uint32(m)) }
func (m AHB3ENR_Bits) Store(b uint32) { rcc(14).StoreBits(uint32(m), b) }
func (m AHB3ENR_Bits) LoadVal() int   { return rcc(14).Field(uint32(m)) }
func (m AHB3ENR_Bits) StoreVal(v int) { rcc(14).SetField(uint32(m), v) }

func AHB3ENR_Load() AHB3ENR_Bits   { return AHB3ENR_Bits(rcc(14).Load()) }
func AHB3ENR_Store(b AHB3ENR_Bits) { rcc(14).Store(uint32(b)) }

func (b AHB3ENR_Bits) Field(mask AHB3ENR_Bits) int {
	return bits.Field32(uint32(b), uint32(mask))
}
func Make_AHB3ENR(v int, mask AHB3ENR_Bits) AHB3ENR_Bits {
...
func (m AHB3LPENR_Bits) Set()           { rcc(22).SetBits(uint32(m)) }
func (m AHB3LPENR_Bits) Clear()         { rcc(22).ClearBits(uint32(m)) }
func (m AHB3LPENR_Bits) Load() uint32   { return rcc(22).Bits(uint32(m)) }
func (m AHB3LPENR_Bits) Store(b uint32) { rcc(22).StoreBits(uint32(m), b) }
func (m AHB3LPENR_Bits) LoadVal() int   { return rcc(22).Field(uint32(m)) }
func (m AHB3LPENR_Bits) StoreVal(v int) { rcc(22).SetField(uint32(m), v) }

func AHB3LPENR_Load() AHB3LPENR_Bits   { return AHB3LPENR_Bits(rcc(22).Load()) }
func AHB3LPENR_Store(b AHB3LPENR_Bits) { rcc(22).Store(uint32(b)) }

func (b AHB3LPENR_Bits) Field(mask AHB3LPENR_Bits) int {
	return bits.Field32(uint32(b), uint32(mask))
}
func Make_AHB3LPENR(v int, mask AHB3LPENR_Bits) AHB3LPENR_Bits {
