...
static inline uintptr
internal$Syscall5(uintptr trap, uintptr a1, uintptr a2, uintptr a3, uintptr a4, uintptr a5) {
	register uintptr rax asm("%rax") = trap;
	register uintptr rdi asm("%rdi") = a1;
	register uintptr rsi asm("%rsi") = a2;
	register uintptr rdx asm("%rdx") = a3;
...
static inline uintptr
internal$Syscall6(uintptr trap, uintptr a1, uintptr a2, uintptr a3, uintptr a4, uintptr a5, uintptr a6) {
	register uintptr rax asm("%rax") = trap;
	register uintptr rdi asm("%rdi") = a1;
	register uintptr rsi asm("%rsi") = a2;
	register uintptr rdx asm("%rdx") = a3;
