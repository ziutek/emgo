...
//  SYSTICK  0xE000E010
// Registers:
//	0x00 32  CSR   SysTick Control and Status Register (any read clears COUNTFLAG)
//	0x04 32  RVR   SysTick Reload Value Register.
//	0x08 32  CVR   SysTick Current Value Register.
//	0x0C 32  CALIB SysTick Calibration Value Register.
package systick
