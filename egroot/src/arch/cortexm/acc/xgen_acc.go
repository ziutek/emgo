...
func (p *ACC_Periph) ITCMEN() ITCMCR_Mask {
	return ITCMCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(ITCMEN)}}
}

func (p *ACC_Periph) ITCMRMW() ITCMCR_Mask {
	return ITCMCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(ITCMRMW)}}
}

func (p *ACC_Periph) ITCMRETEN() ITCMCR_Mask {
	return ITCMCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(ITCMRETEN)}}
}

func (p *ACC_Periph) ITCMSZ() ITCMCR_Mask {
	return ITCMCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 0)), uint32(ITCMSZ)}}
}
...
func (p *ACC_Periph) DTCMEN() DTCMCR_Mask {
	return DTCMCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(DTCMEN)}}
}

func (p *ACC_Periph) DTCMRMW() DTCMCR_Mask {
	return DTCMCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(DTCMRMW)}}
}

func (p *ACC_Periph) DTCMRETEN() DTCMCR_Mask {
	return DTCMCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(DTCMRETEN)}}
}

func (p *ACC_Periph) DTCMSZ() DTCMCR_Mask {
	return DTCMCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 4)), uint32(DTCMSZ)}}
}
...
func (p *ACC_Periph) AHBPEN() AHBPCR_Mask {
	return AHBPCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(AHBPEN)}}
}

func (p *ACC_Periph) AHBPSZ() AHBPCR_Mask {
	return AHBPCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 8)), uint32(AHBPSZ)}}
}
...
func (p *ACC_Periph) SIWT() CACR_Mask {
	return CACR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(SIWT)}}
}

func (p *ACC_Periph) ECCDIS() CACR_Mask {
	return CACR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(ECCDIS)}}
}

func (p *ACC_Periph) FORCEWT() CACR_Mask {
	return CACR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 12)), uint32(FORCEWT)}}
}
...
func (p *ACC_Periph) CTL() AHBSCR_Mask {
	return AHBSCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(CTL)}}
}

func (p *ACC_Periph) TPRI() AHBSCR_Mask {
	return AHBSCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(TPRI)}}
}

func (p *ACC_Periph) INITCOUNT() AHBSCR_Mask {
	return AHBSCR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 16)), uint32(INITCOUNT)}}
}
...
func (p *ACC_Periph) ITCM() ABFSR_Mask {
	return ABFSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 24)), uint32(ITCM)}}
}

func (p *ACC_Periph) DTCM() ABFSR_Mask {
	return ABFSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 24)), uint32(DTCM)}}
}

func (p *ACC_Periph) AHBP() ABFSR_Mask {
	return ABFSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 24)), uint32(AHBP)}}
}

func (p *ACC_Periph) AXIM() ABFSR_Mask {
	return ABFSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 24)), uint32(AXIM)}}
}

func (p *ACC_Periph) EPPB() ABFSR_Mask {
	return ABFSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 24)), uint32(EPPB)}}
}

func (p *ACC_Periph) AXIMTYPE() ABFSR_Mask {
	return ABFSR_Mask{mmio.UM32{(*mmio.U32)(unsafe.Pointer(uintptr(unsafe.Pointer(p)) + 24)), uint32(AXIMTYPE)}}
}
